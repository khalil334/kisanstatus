      ...
      <div className="container-site py-10">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <section className="card">
            <h2 className="text-lg font-bold text-[var(--color-text)] mb-3">Purpose of This Website</h2>
          ...
          {/* What we are NOT */}
          <section className="card">
            <h2 className="text-lg font-bold text-[var(--color-text)] mb-3">What This Website Does NOT Do</h2>
            <ul className="text-sm text-[var(--color-text-muted)] space-y-2">
              {[
          ...
          <section className="card">
            ...
            <p className="text-sm text-[var(--color-text-muted)] leading-relaxed">
              The original content, design, and code on KisanStatus.com is copyright © 2026 KisanStatus.com. All rights reserved. Government data,
