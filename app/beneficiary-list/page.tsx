...
export const metadata: Metadata = {
  title: 'PM Kisan Beneficiary List 2026 — All States & UTs | Village Wise Check',
  description: 'PM Kisan beneficiary list 2026 — apna state select karo aur village wise list check karo. All 37 states and UTs covered. Free online guide.',
  keywords: [
    'PM Kisan beneficiary list 2026',
    'PM Kisan state wise list',
  ...
  openGraph: {
    ...
    description: 'Apna state select karo aur village wise beneficiary list check karo. 37 states/UTs covered.',
    type: 'website',
    url: `${DOMAIN}/beneficiary-list`,
    siteName: 'KisanStatus.com',
    locale: 'hi_IN',
    images: [{ url: `${DOMAIN}/images/pm-kisan-beneficiary-list-2026.webp`, width: 1200, height: 630, alt: 'PM Kisan Beneficiary List 2026' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'PM Kisan Beneficiary List 2026 — All States & UTs',
    description: 'Apna state select karo aur village wise list check karo.',
    site: '@kisanstatus',
    images: [`${DOMAIN}/images/pm-kisan-beneficiary-list-2026.webp`],
  },
};
...
const schema = {
  ...
  '@type': 'CollectionPage',
  name: 'PM Kisan Beneficiary List 2026 — All States & UTs',
  description: 'PM Kisan beneficiary list 2026 — select your state and check village wise list. All 37 states and UTs covered.',
  url: `${DOMAIN}/beneficiary-list`,
  inLanguage: 'hi-IN',
    ...
    <>
      ...
      >
        <div className="container-site text-center">
          ...
          <p className="text-green-200 text-sm md:text-base max-w-xl mx-auto mb-4">
            Apna state select karo aur village wise beneficiary list check karo.
      ...
      <div className="container-site py-10">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-8 shadow-sm">
          <h2 className="font-black text-gray-900 text-lg mb-4">📋 Village Wise List Kaise Dekhein?</h2>
          <ol className="space-y-3">
            {[
              'Neeche apna <strong>State</strong> select karo',
              'State page par <strong>District, Block, Village</strong> select karo',
              '<strong>"Get Report"</strong> click karo — poori list aa jayegi',
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mb-8">
          ...
          <ul className="space-y-2 text-sm text-yellow-900">
            <li>• Beneficiary list sirf <strong>registered farmers</strong> ki dikhti hai</li>
            <li>• Agar naam nahi hai toh <Link href="/articles/pm-kisan-registration-online-2026" className="font-bold underline hover:text-yellow-700">naya registration</Link> karo</li>
            ...
            <li>• eKYC pending hai? <Link href="/articles/pm-kisan-ekyc-online-2026" className="font-bold underline hover:text-yellow-700">eKYC Guide</Link> follow karo</li>
          </ul>
        </div>

        {/* Related Guides */}
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
          <h3 className="font-black text-green-900 text-base mb-4">📖 Related PM Kisan Guides</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[
              ...
              { href: '/articles/pm-kisan-registration-online-2026', label: '📝 Registration' },
              { href: '/articles/pm-kisan-name-correction-online-2026', label: '✏️ Name Correction' },
