  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        {/* Icon */}
        <div 
          className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-green-100 dark:bg-green-900/30 text-4xl mb-2"
          aria-hidden="true"
        >
          🔍
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[var(--color-text-muted)] text-sm md:text-base leading-relaxed">
            ...
            Aapko <strong aria-live="polite">{countdown}</strong> second mein Homepage par redirect kar diya jayega.
          </p>
        </div>
