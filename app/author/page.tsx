...
export const metadata: Metadata = {
  ...
  description:
    'KisanStatus Team ek group of agricultural experts hai jo farmer welfare schemes aur sarkari yojanaon ki verified jankari Indian kisaanon tak pahunchate hain. Step-by-step guides.',
  authors: [{ name: 'KisanStatus Team', url: 'https://kisanstatus.com/about' }],
  alternates: { canonical: 'https://kisanstatus.com/author' },
  openGraph: {
    title: 'KisanStatus Team — Agricultural Experts | KisanStatus.com',
    description: 'Farmer welfare experts ki team jo verified jankari deti hai — KisanStatus.com ke baare mein jaaniye.',
    type: 'profile',
...
const organizationSchema = {
  ...
  description: 'Indian cultivators ke liye agrarian welfare schemes ki verified jankari dene wali team. Step-by-step guides, beneficiary verification, digital authentication help.',
  foundingDate: '2024',
  knowsAbout: [
  ...
  member: [
    {
      ...
      description: 'Agricultural experts jo farmer welfare guides likhte hain',
    },
    {
      '@type': 'OrganizationRole',
    ...
    },
    {
      ...
      description: 'Cultivator queries ka answer dete hain',
    },
  ],
  sameAs: [
    ...
    <>
      ...
      <div className="container-site py-10 max-w-3xl mx-auto">
        ...
        <div className="card mb-8 border-[var(--color-border)]">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-[var(--color-primary)] font-semibold text-sm mt-0.5">Agricultural Experts &amp; Farmer Advocates</p>
              ...
              <div className="flex flex-wrap gap-2 mt-4 justify-center sm:justify-start">
                {['Agrarian Welfare Experts', 'Kisan Support', 'Sarkari Yojana', 'Digital Verification Guide', 'Agricultural Policy', 'Verified Data'].map((tag) => (
          ...
          <div className="mt-6 pt-6 border-t border-[var(--color-border)] space-y-3 text-sm text-[var(--color-text-muted)] leading-relaxed">
            <p>
              <strong>KisanStatus Team</strong> ek dedicated group of agricultural experts hai jo Indian cultivators ke haq mein kaam karte hain.
              Hamara mission hai ki har kisan ko farmer welfare schemes aur doosri sarkari yojanaon ki sahi, aasaan aur
              up-to-date jankari mile — bina kisi pareshan ke.
            </p>
            <p>
              Humne <strong>KisanStatus.com</strong> isliye banaya kyunki lakho kisaanon ko verified information ke liye baar baar
          ...
          <div className="mt-6 pt-6 border-t border-[var(--color-border)]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <div className="text-xs text-[var(--color-text-muted)] mt-1">Detailed Guides</div>
              </div>
              <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <div className="text-2xl font-bold text-[var(--color-primary)]">10L+</div>
                <div className="text-xs text-[var(--color-text-muted)] mt-1">Farmers Helped</div>
              </div>
              <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
        ...
        <div className="card mb-6">
          <h2 className="text-xl font-bold text-[var(--color-text)] mb-4">📝 KisanStatus Team Ke Articles</h2>
