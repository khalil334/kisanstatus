...
const COMPONENTS: Record<string, React.ComponentType<{ article: HindiArticle }>> = {
  ...
  TractorSubsidy2027StateWiseList: dynamic(() => import('@/components/articles/hindi-kisanguides/TractorSubsidy2027StateWiseList'), { ssr: true }),
  GehuKaRateAajMspVsMandiBhav: dynamic(() => import('@/components/articles/hindi-loan-mandi-pashupalan/GehuKaRateAajMspVsMandiBhav'), { ssr: true }),
  ...
  KccLimitKaiseBadhaye3Se5Lakh: dynamic(() => import('@/components/articles/hindi-loan-mandi-pashupalan/KccLimitKaiseBadhaye3Se5Lakh'), { ssr: true }),
  ...
  GauMutraKharidYojanaHindi: dynamic(() => import('@/components/articles/hindi-loan-mandi-pashupalan/GauMutraKharidYojanaHindi'), { ssr: true }),
  NamoDroneDidiYojanaHindi: dynamic(() => import('@/components/articles/hindi-kisanguides/NamoDroneDidiYojanaHindi'), { ssr: true }),
  ...
  FasalBimaClaimStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana-2026/FasalBimaClaimStatusHindi'), { ssr: true }),
  KisanKarjMafiAllStatesHindi: dynamic(() => import('@/components/articles/hindi-yojana-2026/KisanKarjMafiAllStatesHindi'), { ssr: true }),
