...
const COMPONENTS: Record<string, React.ComponentType<{ article: HindiArticle }>> = {
  ...
  RajasthanKisanSammanNidhiHindi: dynamic(() => import('@/components/articles/hindi-yojana/RajasthanKisanSammanNidhiHindi'), { ssr: true }),
  AnnadataSukhibhavaStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/AnnadataSukhibhavaStatusHindi'), { ssr: true }),
  RythuBharosaStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/RythuBharosaStatusHindi'), { ssr: true }),
  KrishakBandhuStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/KrishakBandhuStatusHindi'), { ssr: true }),
  OdishaCmKisanStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/OdishaCmKisanStatusHindi'), { ssr: true }),
  PatiPatniPmKisanRuleHindi: dynamic(() => import('@/components/articles/hindi-yojana/PatiPatniPmKisanRuleHindi'), { ssr: true }),
  StateKisanYojanaListHindi: dynamic(() => import('@/components/articles/hindi-yojana/StateKisanYojanaListHindi'), { ssr: true }),
  KrishakUnnatiYojanaStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/KrishakUnnatiYojanaStatusHindi'), { ssr: true }),
  MeriFasalMeraByoraStatusHindi: dynamic(() => import('@/components/articles/hindi-yojana/MeriFasalMeraByoraStatusHindi'), { ssr: true }),
