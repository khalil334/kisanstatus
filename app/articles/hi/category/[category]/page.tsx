...
const CATEGORY_DATA: Record<CategorySlug, {
  ...
  'loan': {
    ...
    description:
      'KCC लिमिट कैसे बढ़ाएं, कर्ज माफी लिस्ट में नाम कैसे देखें — किसान लोन और क्रेडिट की आसान हिंदी गाइड।',
  ...
  'mandi': {
    ...
    description:
      'गेहूं का आज का रेट, MSP vs मंडी भाव — बाजार दरों की ताज़ा जानकारी आसान हिंदी में।',
    keywords: ['गेहूं का रेट आज', 'मंडी भाव हिंदी', 'msp रेट'],
  },
  'pashupalan': {
    title: 'पशुपालन और मत्स्य पालन — हिंदी गाइड',
    description:
      'गौ मूत्र खरीद योजना समेत पशुपालन से जुड़ी सरकारी योजनाओं की आसान हिंदी गाइड।',
    keywords: ['पशुपालन योजना', 'गौ मूत्र खरीद योजना', 'pashupalan yojana hindi'],
  },
  'agri-business': {
    title: 'कृषि व्यवसाय और सब्सिडी — हिंदी गाइड',
    description:
      'ट्रैक्टर सब्सिडी, नमो ड्रोन दीदी योजना — कृषि व्यवसाय और सब्सिडी की step-by-step हिंदी गाइड।',
