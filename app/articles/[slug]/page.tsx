...
const COMPONENTS: Record<string, React.ComponentType<{ article: ArticleMeta }>> = {
  ...
  JansamarthPortalLoanApply: dynamic(() => import('@/components/articles/loan-mandi-pashupalan/JansamarthPortalLoanApply'), { ssr: true }),
  MspList202627: dynamic(() => import('@/components/articles/loan-mandi-pashupalan/MspList202627'), { ssr: true }),
  MandiBhavAppComparison: dynamic(() => import('@/components/articles/loan-mandi-pashupalan/MandiBhavAppComparison'), { ssr: true }),
  GehuKaBhavMspVsMandi: dynamic(() => import('@/components/articles/loan-mandi-pashupalan/GehuKaBhavMspVsMandi'), { ssr: true }),
  SabziBhavGuidePyazAlooTamatar: dynamic(() => import('@/components/articles/loan-mandi-pashupalan/SabziBhavGuidePyazAlooTamatar'), { ssr: true }),
