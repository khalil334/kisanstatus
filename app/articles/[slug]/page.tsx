...
const COMPONENTS: Record<string, React.ComponentType<{ article: ArticleMeta }>> = {
  ...
  EnamRegistrationKaiseKare: dynamic(() => import('@/components/articles/new-articles/EnamRegistrationKaiseKare'), { ssr: true }),
  DairyFarmLoanWithoutCollateral: dynamic(() => import('@/components/articles/new-articles/DairyFarmLoanWithoutCollateral'), { ssr: true }),
  SbiDairyLoanInterestRate: dynamic(() => import('@/components/articles/new-articles/SbiDairyLoanInterestRate'), { ssr: true }),
  JansamarthPortalLoanApply: dynamic(() => import('@/components/articles/new-articles/JansamarthPortalLoanApply'), { ssr: true }),
  MspList202627: dynamic(() => import('@/components/articles/new-articles/MspList202627'), { ssr: true }),
  MandiBhavAppComparison: dynamic(() => import('@/components/articles/new-articles/MandiBhavAppComparison'), { ssr: true }),
  GehuKaBhavMspVsMandi: dynamic(() => import('@/components/articles/new-articles/GehuKaBhavMspVsMandi'), { ssr: true }),
  SabziBhavGuidePyazAlooTamatar: dynamic(() => import('@/components/articles/new-articles/SabziBhavGuidePyazAlooTamatar'), { ssr: true }),
  MurgiPalanLoanNlmSubsidy: dynamic(() => import('@/components/articles/new-articles/MurgiPalanLoanNlmSubsidy'), { ssr: true }),
  BiharPashupalanLoanYojana: dynamic(() => import('@/components/articles/new-articles/BiharPashupalanLoanYojana'), { ssr: true }),
  RashtriyaGokulMissionSubsidy: dynamic(() => import('@/components/articles/new-articles/RashtriyaGokulMissionSubsidy'), { ssr: true }),
};
