...
const COMPONENTS: Record<string, React.ComponentType<{ article: ArticleMeta }>> = {
  ...
  EnamRegistrationKaiseKare: dynamic(() => import('@/components/articles/low-competition/EnamRegistrationKaiseKare'), { ssr: true }),
  DairyFarmLoanWithoutCollateral: dynamic(() => import('@/components/articles/low-competition/DairyFarmLoanWithoutCollateral'), { ssr: true }),
  SbiDairyLoanInterestRate: dynamic(() => import('@/components/articles/low-competition/SbiDairyLoanInterestRate'), { ssr: true }),
  JansamarthPortalLoanApply: dynamic(() => import('@/components/articles/low-competition/JansamarthPortalLoanApply'), { ssr: true }),
  MspList202627: dynamic(() => import('@/components/articles/low-competition/MspList202627'), { ssr: true }),
  MandiBhavAppComparison: dynamic(() => import('@/components/articles/low-competition/MandiBhavAppComparison'), { ssr: true }),
  GehuKaBhavMspVsMandi: dynamic(() => import('@/components/articles/low-competition/GehuKaBhavMspVsMandi'), { ssr: true }),
  SabziBhavGuidePyazAlooTamatar: dynamic(() => import('@/components/articles/low-competition/SabziBhavGuidePyazAlooTamatar'), { ssr: true }),
  MurgiPalanLoanNlmSubsidy: dynamic(() => import('@/components/articles/low-competition/MurgiPalanLoanNlmSubsidy'), { ssr: true }),
  BiharPashupalanLoanYojana: dynamic(() => import('@/components/articles/low-competition/BiharPashupalanLoanYojana'), { ssr: true }),
  RashtriyaGokulMissionSubsidy: dynamic(() => import('@/components/articles/low-competition/RashtriyaGokulMissionSubsidy'), { ssr: true }),
};
