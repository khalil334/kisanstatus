...
### 3. MGNREGA Pashu Shed Yojana — ₹1.6 Lakh Tak ✅ PUBLISHED 2026-08-18
- **Live:** `/yojana/mgnrega-pashu-shed-yojana` (Hinglish) + `/articles/hi/mgnrega-pashu-shed-yojana` (Hindi) · hreflang paired · sitemap + cross-links auto · contextual links added in BakriPalanYojana (DPR capital-cost section) + MurgiPalanLoanNlmSubsidy (backyard-scale note).
- **Verified is article me:** koi online form/portal exist nahi karta — MGNREGA individual beneficiary works category, gram panchayat → gram sabha → annual action plan → technical sanction ka rasta; ₹75k–₹1.6L figures state estimates hain, koi fixed national amount notify nahi (article me table ko "andaza" mark kiya); payment split = NREGA wage (muster roll) + material (vendor), cash transfer nahi; pehle-se-bana shed par payment nahi; complaint route rozgar sevak → gram sabha → BDO/PO → DC/DM.
...
### 4. Pashu Kisan Credit Card — ₹3 Lakh Tak Loan ✅ PUBLISHED 2026-08-18
- **Live:** `/yojana/pashu-kisan-credit-card-apply` (Hinglish) + `/articles/hi/pashu-kisan-credit-card` (Hindi) · hreflang paired · sitemap + cross-links auto · contextual links added in KisanCreditCardOnlineApply2026 (KCC-AH section) + DairyFarmLoanWithoutCollateral (working-capital para).
- **Verified is article me:** Haryana scale of finance per pashu — bhains ₹60,249 / gaay ₹40,783 / bakri-bhed ₹4,063 / suar ₹16,337 / murgi layer ₹720, broiler ₹161; overall cap ₹3L; 7% − 3% PRI = 4% effective (RBI KCC-AH subvention circular FIDD.CO.FSD.BC.No.10/05.02.001/2019-20); AH-only subvention cap ₹2L, crop+AH combined ₹3L; collateral-free limit ₹1.6L → ₹2L (RBI Dec 2024, effective Jan 2025) — purane blogs 1.6L likhte hain, article me correction; landless eligible (limit pashu-based, not land-based); existing KCC holders ko sub-limit enhancement, dusra card nahi; Haryana 12-digit tagging requirement.
...
### 7. Kisan Karj Mafi 2026 — Kis State Me Sach Me Chal Rahi Hai ✅ PUBLISHED 2026-08-18
- **Live:** `/yojana/kisan-karj-mafi-list-all-states` (Hinglish) + `/articles/hi/kisan-karj-mafi-list` (Hindi) · hreflang paired · sitemap + cross-links auto · contextual links added in KisanRinKahaSeLe2026 + KisanCreditCardOnlineApply2026.
- **Verified is article me:** Maharashtra Punyashlok Ahilyadevi Holkar Karjmafi (Budget 2026-27, approved June 2026, ~₹36,585 cr, ₹2L tak, cut-off 30 Sep 2025, ₹50k regular-payer incentive, phase-1 ~31 lakh kisan, >₹2L ke liye OTS, **koi form nahi — portal par "अर्ज करण्याची आवश्यकता नाही"**); Telangana Rythu Runa Mafi **2024 me poori** (3 phase, ₹17,934 cr, ~22.37 lakh kisan: 11,50,193 / 6,40,823 / 4,46,832; ration card = family, mahila ka loan pehle); UP Rin Mochan **2017 ki purani scheme** (₹1L, outstanding 31 Mar 2016, portal down verify kiya); TN ₹75,000 sahkari — sirf ghoshna; Chhattisgarh ko jaan-boojh kar table se bahar rakha (Krishak Unnati ₹15,000/acre = input aid, karj mafi nahi); ARDRS 1990 / ADWDRS 2008 / post-2014 ~₹2.5 lakh cr = 1.4% GDP; RBI IWG 2019 election-cycle correlation.
- **Structural element:** top par update-log block (date + kya badla) — har 2 mahine refresh hoga.
