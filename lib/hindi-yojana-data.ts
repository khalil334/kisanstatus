...
export const HINDI_YOJANA_ARTICLES: readonly HindiArticle[] = [
  ...
  },
  {
    ...
    seoTitleHi: 'किसान आईडी (Farmer ID) कैसे बनाएं 2026 — Documents',
    desc: 'किसान आईडी (AgriStack Farmer ID) free बनती है, एक भी पैसा नहीं लगता। मोबाइल से 10 मिनट में apply करें — documents की list और अपने राज्य का portal यहां।',
    keywords: ['किसान आईडी कैसे बनाएं', 'farmer id kaise banaye', 'agristack id kaise banaye', 'farmer id banane ke liye documents', 'किसान आईडी कार्ड', 'agristack farmer id', 'farmer id banane me kitna time lagta hai', 'agristack id kya hai'],
    category: 'farming',
    publishedTime: '2026-06-07T21:01:19+05:30',
    modifiedTime: '2026-08-18T06:00:00+05:30',
    author: AUTHOR_NAME,
