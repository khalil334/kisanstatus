...
const t: Record<LangCode, Translations> = {
  ...
  bn: {
    ...
    footer_copyright: `© ২০২৬ KisanStatus.com by ${AUTHOR_NAME} — শুধুমাত্র তথ্যমূলক উদ্দেশ্যে`,
  ...
  ta: {
    ...
    footer_copyright: `© 2026 KisanStatus.com by ${AUTHOR_NAME} — தகவல் நோக்கங்களுக்காக மட்டுமே`,
  ...
  te: {
    ...
    footer_copyright: `© 2026 KisanStatus.com by ${AUTHOR_NAME} — సమాచార ప్రయోజనాల కోసం మాత్రమే`,
  ...
  mr: {
    ...
    footer_copyright: `© 2026 KisanStatus.com by ${AUTHOR_NAME} — केवळ माहिती हेतूंसाठी`,
  ...
  pa: {
    ...
    footer_copyright: `© 2026 KisanStatus.com by ${AUTHOR_NAME} — ਸਿਰਫ ਜਾਣਕਾਰੀ ਉਦੇਸ਼ਾਂ ਲਈ`,
  ...
  gu: {
    ...
    footer_copyright: `© 2026 KisanStatus.com by ${AUTHOR_NAME} — માત્ર માહિતી હેતુઓ માટે`,
