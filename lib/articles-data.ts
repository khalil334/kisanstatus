...
export const ARTICLES: readonly ArticleMeta[] = [
  ...
  },
  {
    ...
    keywords: [
      'pm kisan correction form kaise bhare',
      'pm kisan naam correction online',
      'pm kisan bank account update kaise kare',
      'pm kisan aadhaar seeding error fix',
      'pm kisan self registered farmer correction',
      'pm kisan farmer corner edit details',
      'pm kisan gender/DOB correction',
      'pm kisan application rejected reason',
      'pm kisan mobile number update',
      'pm kisan land record mismatch solution',
      'pm kisan CSC se correction kaise kare',
      'pm kisan name spelling mistake fix online',
      'pm kisan wrong ifsc code correction',
      'pm kisan aadhaar link but payment failed',
      'pm kisan edit bank details not working',
      'pm kisan correction form offline download',
      'pm kisan self correction vs csc correction',
      'pm kisan bank seeding pending meaning',
      'pm kisan correction ke baad kitne din mein paisa aayega',
      'pm kisan mobile number change without old sim',
      'pm kisan beneficiary status inactive reason',
      'pm kisan correction status check online',
      'pm kisan name correction certificate format',
      'pm kisan edit aadhaar details otp not coming',
      'pm kisan correction form pdf download',
      'pm kisan bank account change without visiting branch',
    ],
  ...
  // ✅ NEW ARTICLE ADDED
  {
    ...
    keywords: [
      ...
      'pm kusum yojana online apply kaise kare 2026',
      'pm kusum yojana registration form kaise bhare',
      'solar pump subsidy apply kaise kare kisan',
      'pm kusum yojana ka status kaise check kare',
      'pm kusum yojana approval time kitna lagta hai',
      'pm kusum yojana eligibility criteria kya hai',
      'solar pump subsidy ke liye kaunse document chahiye',
      'pm kusum yojana ke liye kitni zameen chahiye',
      'pm kusum yojana land record requirement',
      'pm kusum yojana mein kitni subsidy milti hai',
      '90 percent subsidy solar pump kaise milega',
      'pm kusum yojana subsidy amount state wise',
      'solar pump ki price subsidy ke baad kitni hogi',
      'pm kusum component a b c kya hai',
      'kusum yojana solar pump vs grid connected solar',
      '2kw 3kw 5kw solar pump subsidy price',
      'pm kusum yojana rajasthan online apply',
      'pm kusum yojana up registration',
      'pm kusum yojana mp online form',
      'pm kusum yojana maharashtra apply kaise kare',
      'pm kusum yojana bihar solar pump',
      'pm kusum yojana application reject kyu hota hai',
      'solar pump subsidy paise kab tak milte hain',
      'pm kusum yojana bank loan kaise le',
      'purana diesel pump se solar pump mein badlaw kaise kare',
      'solar pump vs diesel pump kisan ke liye',
      'pm kusum yojana vs private solar company',
      'kusum yojana component b standalone solar pump',
      'pm kusum yojana land record verification',
      'solar pump subsidy scheme for farmers 2026',
      'pm kusum yojana status check online',
      'pm kusum yojana application rejected reasons',
      'solar pump vs diesel pump cost comparison',
      'pm kusum yojana helpline number',
      'bijli bill aayega kya solar pump pe',
      'vendor khud choose kar sakte hain kusum',
      'application ke baad survey kab hota hai',
    ],
