...
export const ARTICLES: ArticleMeta[] = [
  // 1
  {
    ...
    keywords:  [
      'Kisan Rin Kaha Se Le 2026', 'Kisan Credit Card', 'Kisan Loan 2026', 'SBI Kisan Loan', 'CSC Center Loan',
      'किसान ऋण कहाँ से लें', 'किसान लोन 2026', 'किसान क्रेडिट कार्ड', 'एसबीआई किसान लोन', 'सीएससी सेंटर लोन',
      'kisan loan kaise le', 'kisan rin 2026', 'kisan credit card apply',
    ],
  ...
  // 2
  {
    ...
    keywords:  [
      'Kisan Tractor Loan Kaise Le Bina Down Payment', 'Tractor Loan 2026', 'Tractor Loan Eligibility', 'Tractor Loan Documents',
      'किसान ट्रैक्टर लोन 2026', 'ट्रैक्टर लोन बिना डाउन पेमेंट', 'ट्रैक्टर फाइनेंस', 'किसान ट्रैक्टर सब्सिडी',
      'tractor loan bank se kaise le', 'tractor loan without down payment', 'kisan tractor finance 2026',
    ],
  ...
  // 3
  {
    ...
    keywords:  [
      'PM Kisan 21vi installment status check', 'PM Kisan 21vi kist 2026', 'PM Kisan payment status check online',
      'पीएम किसान 21वीं किस्त स्टेटस', 'पीएम किसान 21वीं किस्त 2026', 'पीएम किसान पेमेंट स्टेटस',
      'pm kisan 21 kist status', 'pm kisan installment check aadhaar', 'pm kisan 21vi kist kab aayi',
    ],
  ...
  // 4
  {
    ...
    keywords:  [
      'PM Kisan beneficiary list 2026', 'PM Kisan village wise list', 'PM Kisan list mein naam check', 'PM Kisan PDF download',
      'पीएम किसान लाभार्थी सूची 2026', 'पीएम किसान गांव वार सूची', 'पीएम किसान लिस्ट में नाम', 'पीएम किसान पीडीएफ डाउनलोड',
      'pm kisan beneficiary list village wise', 'pm kisan list check online 2026', 'pm kisan naam list dekho',
    ],
  ...
  // 5
  {
    ...
    keywords:  [
      'PM Kisan Beneficiary List Village Wise 2026', 'PM Kisan Village Wise List', 'PM Kisan list me naam kaise dekhen',
      'पीएम किसान ग्राम वार लाभार्थी सूची', 'पीएम किसान गांव की सूची 2026', 'पीएम किसान अपने गांव की लिस्ट',
      'pm kisan gaon ki list 2026', 'pm kisan village beneficiary list check', 'pm kisan gram panchayat list',
    ],
  ...
  // 6
  {
    ...
    keywords:  [
      'PM Kisan correction 2026', 'PM Kisan naam correction kaise kare', 'PM Kisan account deactivate', 'PM Kisan block account fix',
      'पीएम किसान नाम करेक्शन 2026', 'पीएम किसान आधार करेक्शन', 'पीएम किसान बैंक अपडेट', 'पीएम किसान डीएक्टिवेट खाता',
      'pm kisan naam theek karo', 'pm kisan bank account update 2026', 'pm kisan correction online kaise kare',
    ],
  ...
  // 7
  {
    ...
    keywords:  [
      'PM Kisan eKYC online 2026', 'PM Kisan eKYC kaise kare', 'PM Kisan Aadhaar OTP eKYC', 'PM Kisan CSC eKYC',
      'पीएम किसान ईकेवाईसी 2026', 'पीएम किसान आधार ओटीपी ईकेवाईसी', 'पीएम किसान सीएससी बायोमेट्रिक',
      'pm kisan ekyc ghar baithe', 'pm kisan ekyc status check 2026', 'pm kisan ekyc free kaise kare',
    ],
  ...
  // 8
  {
    ...
    keywords:  [
      'PM Kisan Installment History Check Online', 'PM Kisan Payment History Check', 'PM Kisan purani installment kaise dekhen',
      'पीएम किसान किस्त इतिहास ऑनलाइन', 'पीएम किसान पुरानी किस्त कैसे देखें', 'पीएम किसान पेमेंट हिस्ट्री',
      'pm kisan sari kist history', 'pm kisan previous payment check', 'pm kisan installment list online 2026',
    ],
  ...
  // 9
  {
    ...
    keywords:  [
      'PM Kisan Land Seeding Status Check', 'Land Seeding Pending Fix', 'PM Kisan Installment Not Coming',
      'पीएम किसान लैंड सीडिंग स्टेटस', 'पीएम किसान जमीन लिंक नहीं', 'लैंड सीडिंग पेंडिंग कैसे ठीक करें',
      'pm kisan land seeding kya hota hai', 'pm kisan zameen link nahi 2026', 'land seeding no fix kaise kare',
    ],
  ...
  // 10
  {
    ...
    keywords:  [
      'PM Kisan name correction online 2026', 'PM Kisan naam correction kaise kare', 'PM Kisan Aadhaar name mismatch',
      'पीएम किसान नाम सुधार 2026', 'पीएम किसान आधार नाम मिसमैच', 'पीएम किसान स्पेलिंग गलत कैसे ठीक करें',
      'pm kisan naam galat fix', 'pm kisan naam update online 2026', 'pm kisan aadhaar naam theek karo',
    ],
  ...
  // 11
  {
    ...
    keywords:  [
      'PM Kisan payment failed 2026', 'PM Kisan payment fail reason', 'PM Kisan NPCI error', 'PM Kisan payment nahi aayi solution',
      'पीएम किसान पेमेंट फेल 2026', 'पीएम किसान पैसा नहीं आया', 'पीएम किसान एनपीसीआई एरर', 'पीएम किसान पेमेंट रुकी',
      'pm kisan paisa kyon nahi aaya', 'pm kisan payment fail fix kaise kare', 'pm kisan bank verification problem',
    ],
  ...
  // 12
  {
    ...
    keywords:  [
      'PM Kisan problems solution 2026', 'PM Kisan RFT signed matlab', 'PM Kisan PFMS pending', 'PM Kisan payment fail solution',
      'पीएम किसान समस्या समाधान 2026', 'पीएम किसान आरएफटी साइन्ड मतलब', 'पीएम किसान पीएफएमएस पेंडिंग',
      'pm kisan RFT signed kya hai', 'pm kisan PFMS error fix', 'pm kisan samasya ka hal 2026',
    ],
  ...
  // 13
  {
    ...
    keywords:  [
      'PM Kisan registration online 2026', 'PM Kisan new farmer registration', 'PM Kisan registration kaise kare',
      'पीएम किसान रजिस्ट्रेशन ऑनलाइन 2026', 'पीएम किसान नया किसान पंजीकरण', 'पीएम किसान रजिस्ट्रेशन कैसे करें',
      'pm kisan naya registration kaise kare', 'pm kisan registration status check 2026', 'pm kisan eligibility 2026',
    ],
  ...
  // 14
  {
    ...
    keywords:  [
      'PM Kisan rejected list 2026', 'PM Kisan rejection reason', 'PM Kisan naam rejected', 'PM Kisan application rejected fix',
      'पीएम किसान रिजेक्टेड लिस्ट 2026', 'पीएम किसान नाम रिजेक्ट क्यों हुआ', 'पीएम किसान आवेदन अस्वीकार',
      'pm kisan naam reject kyon hua', 'pm kisan rejected list se naam hataye', 'pm kisan rejection fix 2026',
    ],
  ...
  // 15
  {
    ...
    keywords:  [
      'PMFBY Crop Insurance', 'PMFBY Claim Status Check', 'Pradhan Mantri Fasal Bima Yojana 2026', 'fasal bima yojana claim kaise kare',
      'पीएमएफबीवाई फसल बीमा 2026', 'प्रधानमंत्री फसल बीमा योजना क्लेम', 'फसल बीमा दावा कैसे करें', 'पीएमएफबीवाई स्टेटस',
      'PMFBY claim online kaise kare', 'fasal bima paisa kab aayega', 'crop insurance 2026 india',
    ],
  ...
  // 16
  {
    ...
    keywords:  [
      'PM Kisan 23vi Kist', 'PM Kisan Status Check', '23vi Kist Payment Status', 'PM Kisan Next Installment',
      'पीएम किसान 23वीं किस्त', 'पीएम किसान 23वीं किस्त स्टेटस 2026', 'पीएम किसान तेईसवीं किस्त कब आई',
      'pm kisan 23vi kist status check', 'pm kisan 23vi kist payment date', 'pm kisan 23 installment aai ya nahi',
    ],
  ...
  // 17
  {
    ...
    keywords:  [
      'Kisan Credit Card Online Apply 2026', 'KCC Apply Online', 'KCC Eligibility 2026', 'KCC Loan Limit', 'KCC Interest Rate 2026',
      'किसान क्रेडिट कार्ड ऑनलाइन अप्लाई 2026', 'केसीसी लोन कैसे लें', 'किसान क्रेडिट कार्ड पात्रता', 'किसान क्रेडिट कार्ड ब्याज दर',
      'kcc loan apply kaise kare', 'kisan credit card documents required', 'kcc loan limit 2026',
    ],
  ...
  // 18
  {
    ...
    keywords:  [
      'PM Kisan FTO Generated', 'FTO Generated matlab', 'PM Kisan FTO status', 'FTO processed meaning',
      'पीएम किसान एफटीओ जेनरेटेड मतलब', 'एफटीओ जेनरेटेड क्या होता है', 'पीएम किसान एफटीओ पेंडिंग',
      'pm kisan FTO kya hota hai', 'FTO generated ke baad paisa kab aayega', 'pm kisan payment FTO status 2026',
    ],
  ...
  // 19
  {
    ...
    keywords:  [
      'Nano DAP 500ml price India 2026', 'IFFCO Nano DAP price', 'Nano DAP kaise use kare', 'Nano DAP kahan milega',
      'नैनो डीएपी 500ml कीमत 2026', 'आईएफएफसीओ नैनो डीएपी', 'नैनो डीएपी कैसे उपयोग करें', 'नैनो डीएपी कहाँ मिलेगा',
      'nano dap vs dap kya fark hai', 'nano dap farmer guide 2026', 'IFFCO nano dap price per bottle',
    ],
  ...
  // 20
  {
    ...
    keywords:  [
      'PM Kisan 24vi Kist 2026', 'PM Kisan 24vi installment', 'PM Kisan 24vi kist kab aayegi', 'PM Kisan next installment 2026',
      'पीएम किसान 24वीं किस्त 2026', 'पीएम किसान चौबीसवीं किस्त कब आएगी', 'पीएम किसान अगली किस्त कब आएगी',
      'pm kisan 24vi kist status check', 'pm kisan 24 kist payment date', 'pm kisan next kist 2026 date',
    ],
  ...
  // 21
  {
    ...
    keywords:  [
      'AgriStack kya hai', 'AgriStack 2026', 'Farmer ID AgriStack', 'PM Kisan AgriStack connection',
      'एग्रीस्टैक क्या है', 'किसान आईडी एग्रीस्टैक', 'एग्रीस्टैक रजिस्ट्रेशन 2026', 'फार्मर डिजिटल पहचान',
      'agristack farmer id kaise banaye', 'agristack registration kaise kare', 'agristack benefits for farmers 2026',
    ],
  ...
  // 22
  {
    ...
    keywords:  [
      'PM Kisan mobile number change 2026', 'PM Kisan number update kaise kare', 'PM Kisan CSC mobile update',
      'पीएम किसान मोबाइल नंबर बदलें 2026', 'पीएम किसान फोन नंबर अपडेट', 'पीएम किसान मोबाइल नंबर कैसे बदलें',
      'pm kisan mobile number badlna', 'pm kisan registered mobile change kaise kare', 'pm kisan phone number update 2026',
    ],
