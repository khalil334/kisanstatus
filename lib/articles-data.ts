...
export const ARTICLES: readonly ArticleMeta[] = [
  ...
  },
  {
    ...
    desc: '21vi kist aayi ya nahi — status verify karna simple hai. Aadhaar number dalo, OTP verify karo.',
    ogTitle: 'PM Kisan 21vi Kist Status — 2 Minute Mein Jaano',
    keywords: ['pm kisan 21vi kist status', 'pm kisan 21st installment 2026', 'पीएम किसान 21वीं किस्त स्टेटस'],
