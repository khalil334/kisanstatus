...
export const CORE_ARTICLES: readonly ArticleMeta[] = [
  {
    ...
    readingTime: 8,
    author: 'Manish Kumar',
    authorBio: 'Sarkari kisan yojnaon ki official websites (pmkisan.gov.in, state portals) se information collect karke simple Hindi mein present karta hoon. Yahan di gayi har detail official source se cross-check ki jati hai.',
  ...
  },
  {
    ...
    modifiedTime: '2026-01-15T08:43:23+05:30',
    readingTime: 6,
    author: 'Manish Kumar',
    authorBio: 'Sarkari kisan yojnaon ki official websites (pmkisan.gov.in, state portals) se information collect karke simple Hindi mein present karta hoon. Yahan di gayi har detail official source se cross-check ki jati hai.',
    schemes: ['pm-kisan'],
