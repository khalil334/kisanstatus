    ...
    <>
      ...
      <div className="container-site max-w-3xl py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-4">
            Official PM Kisan portal par apne state ke nodal officer ki updated contact details mil jayengi. Complaint karte waqt do cheezein zaroor likhein. Registration Number aur Application Date. Resolution jaldi hota hai. PMKMY ke saare verified helpline numbers, official email addresses aur shikayat darj karne ka poora tareeka humne <Link href="/maandhan/pmkmy-grievance-complaint-helpline" className="underline text-green-700 dark:text-green-400">PMKMY helpline & grievance guide</Link> mein ek jagah rakha hai.
          </p>
