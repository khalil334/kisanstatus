...
const FAQS = [
  ...
  },
  {
    ...
    a: 'बिल्कुल नहीं — KCC एक revolving सुविधा है, credit card की तरह। ब्याज सिर्फ उतनी रकम पर लगता है जितनी आपने निकाली और जितने दिन रखी। Limit बड़ी होने का अर्थ गुंजाइश है, खर्च की मजबूरी नहीं।',
  },
  {
  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>₹3 लाख से बढ़ाकर ₹5 लाख</strong>। तात्पर्य यह कि अब ₹5 लाख तक का फसली कर्ज भी उसी रियायती
      ...
      <UL>
        ...
        <li>
          ...
          साल भर के लिए साहूकार से लेने पर ब्याज ही ₹24,000-36,000 बैठता है; यही रकम KCC से समय पर
      ...
      <div className="mt-8 p-5 bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-2xl">
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-sm">
          ...
          <li>
            <Link href="/articles/hindi/kisan-karj-mafi-list-rajyawar">📋 कर्ज माफी लिस्ट 2027</Link>
          </li>
        </ul>
      </div>
    </>
