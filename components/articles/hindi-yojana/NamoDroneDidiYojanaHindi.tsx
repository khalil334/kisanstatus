...
const FAQS = [
  ...
  },
  {
    ...
    a: 'तीन रास्ते हैं — समूह की अपनी बचत, AIF से loan (3% ब्याज छूट के साथ), या SHG federation से आंतरिक loan। मान लीजिए package ₹10 लाख का है तो समूह के हिस्से लगभग ₹2 लाख आएंगे। बिना सोचे कर्ज मत लीजिए — पहले इलाके में काम का अंदाजा लगाइए, फिर हामी भरिए।',
  },
  {
    q: 'क्या documents लगते हैं?',
    a: 'बहुत कम। समूह का DAY-NRLM registration, बैठकों और बचत का साफ record, और pilot बनने वाली सदस्य की दसवीं की marksheet + Aadhaar। न जमीन का कागज चाहिए, न income certificate। कोई लंबी list थमाकर पैसे मांगे तो समझ जाइए ठगी है।',
  },
  {
    q: 'बारिश या तेज हवा में ड्रोन से spray हो सकता है क्या?',
    a: 'हल्की बूंदाबांदी में भी नहीं — दवा धुल जाती है और ड्रोन के electronics के लिए भी ठीक नहीं। तेज हवा (करीब 10-12 km/घंटा से ऊपर) में operator खुद मना करेगा, क्योंकि spray बगल के खेत में उड़ जाता है — इसे drift कहते हैं। इसलिए मानसून में spray की window छोटी रहती है; operator से 2-3 दिन पहले बात करके मौसम के हिसाब से slot रखिए।',
  },
  {
    q: 'किसान को spray से पहले क्या तैयारी करनी चाहिए?',
    a: 'तीन बातें: खेत के ऊपर या बगल में बिजली के तार और पेड़ हों तो operator को पहले बता दीजिए, वरना वह मौके पर मना कर देगा। दवा अपनी पसंद की लीजिए, पर घोल operator के हिसाब से बनेगा — जिद मत कीजिए। और spray के दिन खेत में जानवर और बच्चे न हों। बस — बाकी उड़ान का काम operator का है।',
  },
  {
    q: 'क्या यह काम सिर्फ spray तक ही रहेगा?',
    a: 'अभी मुख्य काम nano urea, nano DAP और कीटनाशक का spray है, क्योंकि खाद कंपनियां इसमें partner हैं। पर trained pilot के लिए आगे रास्ते खुलते हैं — फसल की निगरानी, survey का काम, निजी agri-कंपनियों के contract। Budget 2026-27 में सरकार ने दीदियों को service provider से \'enterprise owner\' बनाने की दिशा की बात भी कही है।',
  },
];
...
export default function NamoDroneDidiYojanaHindi({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <p>
        और समझ भी आता है। जब हर सरकारी योजना का कोई न कोई portal होता है — PM Kisan का है, KCC का
        है, तकरीबन सबका है — तो लोग मान लेते हैं कि इसका भी होगा। पर यह योजना अलग ढंग से बनी है।
      ...
      <p>
        जो ड्रोन इस योजना में दिए जाते हैं, वे खिलौने वाले camera drone नहीं हैं — ये खेती के लिए बने
        भारी sprayer drone हैं, जिनमें आम तौर पर 10 litre के आसपास का tank लगा होता है। भरे tank के
      ...
      <p>
        ...
        होने से रहा। कौन सी company का ड्रोन मिलेगा, यह आप नहीं चुनते — procurement ऊपर से होती है और
      ...
      <p>
        यह सवाल अक्सर पूछा जाता है और जायज है। मान लीजिए package ₹10 लाख का बना — 80% यानी ₹8 लाख
        सरकार ने दे दिया, बचा ₹2 लाख। इतनी रकम किसी भी गांव के समूह के लिए छोटी नहीं है, यह मानना
        पड़ेगा। पर रास्ते हैं।
      </p>
      <p>
      ...
      <p>
        ध्यान रखने वाली बात यह है कि 20% का इंतजाम सोचे बिना हां मत करिए। कर्ज लेकर मशीन ली और इलाके
        में काम नहीं निकला, तो किस्त समूह की बैठकों में झगड़े की जड़ बन जाती है। पहले अंदाजा लगाइए कि
        आसपास कितनी खेती है, कितने किसान सचमुच spray करवाएंगे — फिर हामी भरिए।
      </p>

      <T2>कागज-पत्तर और पात्रता — छोटी सूची है</T2>
      <p>
        क्योंकि आवेदन individual नहीं है, इसलिए लंबी-चौड़ी document list भी नहीं है। जो चीजें काम आती
        हैं, वे ये हैं:
      </p>
      ...
      <p>
        बस। न कोई जमीन का कागज चाहिए, न income certificate, न कोई अलग से बनवाने वाला card। जो आदमी
        इनसे आगे की list थमाए और साथ में कोई खर्चा बताए, समझ जाइए मामला गड़बड़ है।
      </p>
      ...
      <p>
        ...
        मजदूरी से बड़ी है — बस इसे कोई गिनता नहीं। आंख में जलन, शाम को सिर भारी, कभी उलटी — ये सब
        knapsack pump वाले जानते हैं, पर इसका हिसाब कोई खर्च में नही जोड़ता।
      </p>
      <p>
        थोड़ा और खोलकर — ड्रोन से spray एक जैसा गिरता है। हाथ से छिड़काव में कहीं ज्यादा गिर गया, कहीं
        छूट गया — नतीजा यह कि कहीं फसल झुलस जाती है और कहीं कीड़ा बच जाता है। ड्रोन नियत ऊंचाई और
      ...
      <p>
        खर्चे का भी एक सच जान लीजिए जो अक्सर छुपा लिया जाता है — battery। खेत में बिजली नहीं होती,
        इसलिए charging का इंतजाम साथ लेकर चलना पड़ता है — generator या गाड़ी से charging। एक battery
        से मोटामोटी दो-ढाई acre निकलते हैं, तो दिन भर काम चाहिए तो 4-6 batteries का set और उनका
        rotation चाहिए। यही वो काम है जो assistant संभालती है — और इसीलिए ड्रोन दीदी अकेले का नहीं, दो
      ...
      <p>
        एक व्यावहारिक सलाह — जब भी जाएं, समूह की 2-3 सदस्य साथ जाएं और अपने समूह का नाम, गांव,
        registration की जानकारी लिखकर ले जाएं। मौखिक बात हवा में उड़ जाती है, लिखित नाम कहीं न कहीं
        दर्ज हो जाता है। और एक बार जाकर भूल मत जाइए — दो-तीन महीने में एक बार हाल पूछ लेना समूह को
      ...
      <p>
        Certificate मिल गया, ड्रोन आ गया — अब? यहां से आगे कोई सरकारी हाथ पकड़कर नहीं चलाता। पहला
        महीना सबसे मुश्किल होता है, क्योंकि गांव के किसान एकदम से भरोसा नहीं करते। नयी चीज है, महंगी
        मशीन है, और चला रही है गांव की ही कोई महिला — तो पहले सब दूर से देखते हैं।
      </p>
      <p>
        जिन समूहों ने यह दौर पार किया, उनका तरीका लगभग एक जैसा रहा — शुरुआत में एक-दो demo मुफ्त या
        आधे rate पर। अपने ही समूह की सदस्यों के घर के खेतों से शुरु कीजिए — वहां ना नहीं होगी। जब
        पड़ोस के खेत वाला देखेगा कि फसल को कुछ नहीं हुआ और काम आधे घंटे में निपट गया, तो अगली बार
        खुद पूछेगा। गांव में सबसे तेज चलने वाला प्रचार आज भी मुंहजुबानी ही है।
      </p>
      <p>
      ...
      <p>
        इस योजना के नाम पर इतनी गलत जानकारी घूम रही है कि एक बार सीधे-सीधे निपटा देना ठीक रहेगा:
      </p>
      <ul className="list-disc pl-5 space-y-2 my-4 text-sm leading-relaxed">
        <li>
      ...
      <p>
        एक आखिरी बात, जो शायद सबसे जरुरी है। यह योजना उन गिनी-चुनी योजनाओं में से है जहां मिलने वाली
        चीज खर्च नहीं, कमाई का जरिया है। ₹2,000 की किस्त आती है और खर्च हो जाती है। ड्रोन आता है तो
        साल-दर-साल कमाता है — बशर्ते समूह उसे चलाना जानता हो और इलाके में काम हो। इसलिए जल्दबाजी में
        नहीं, सोच समझकर उतरिए — पर उतरिए जरूर, क्योंकि गांव की महिलाओं के लिए इतना सीधा technical
        रोजगार देने वाली योजना दूसरी नहीं है।
      </p>
      <p>
