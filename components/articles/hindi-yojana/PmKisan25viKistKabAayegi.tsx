...
const FAQS = [
  {
    ...
    a: 'अभी तक सरकार ने कोई तारीख घोषित नहीं की है। पिछली (24वीं) किस्त 20 जून 2026 को आई थी; चार-महीने के पैटर्न से अगली अक्टूबर 2026 के आसपास संभावित है, पर यह अनुमान है। आधिकारिक घोषणा pmkisan.gov.in और PIB की प्रेस रिलीज़ से ही आती है — उसी पर भरोसा करें।',
  },
  {
...
export default function PmKisan25viKistKabAayegi({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <p>
        सबसे ताजा पक्की घटना यह है — <strong>24वीं किस्त 20 जून 2026 को</strong> प्रधानमंत्री ने पश्चिम
        बंगाल के तारकेश्वर से release की थी — करीब 9.44 करोड़ किसानों को ₹18,880 करोड़। उसी दिन से
        25वीं किस्त की गिनती शुरू हो गई। सरकार किस्त जारी करने की घोषणा आमतौर पर कुछ ही दिन पहले करती
        है — कई बार प्रधानमंत्री किसी कार्यक्रम से बटन दबाकर release करते हैं, और उसी दिन पैसा खातों में
        जाना शुरू होता है। पिछला पैटर्न देखें तो दो किस्तों के बीच करीब चार महीने का फासला रहता आया है —
        इस हिसाब से अगली किस्त अक्टूबर 2026 के आसपास संभावित मानी जा रही है। लेकिन यह पैटर्न है, नियम
        नहीं — फासला कभी थोड़ा घटा है, कभी बढ़ा है, और आधिकारिक तारीख अभी घोषित नहीं हुई है।
      </p>
      <p>
