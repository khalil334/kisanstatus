...
const FAQS = [
  {
    ...
    a: 'अभी तक सरकार ने कोई तारीख घोषित नहीं की है। आखिरी जारी किस्त (23वीं) 20 जून 2026 को आई थी; अभी 24वीं का इंतजार है (अक्टूबर 2026 के आसपास संभावित), और 25वीं उसके बाद 3-4 महीने के पैटर्न से आएगी। यह अनुमान है। आधिकारिक घोषणा pmkisan.gov.in और PIB की प्रेस रिलीज़ से ही आती है. उसी पर भरोसा करें।',
  },
  {
...
export default function PmKisan25viKistKabAayegi({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <p>
        सबसे ताजा पक्की घटना यह है. <strong>23वीं किस्त 20 जून 2026 को</strong> प्रधानमंत्री ने पश्चिम
        बंगाल के तारकेश्वर से release की थी. करीब 9.44 करोड़ किसानों को ₹18,880 करोड़। उसके बाद से
        24वीं का इंतजार चल रहा है (सितंबर 2026 तक घोषणा नहीं हुई; अक्टूबर के आसपास संभावित मानी जा रही
        है), और 25वीं की गिनती उसके बाद शुरू होगी। सरकार किस्त जारी करने की घोषणा आमतौर पर कुछ ही दिन पहले करती
        है. कई बार प्रधानमंत्री किसी कार्यक्रम से बटन दबाकर release करते हैं, और उसी दिन पैसा खातों में
        जाना शुरू होता है। पिछला पैटर्न देखें तो दो किस्तों के बीच करीब तीन-चार महीने का फासला रहता आया है।
        लेकिन यह पैटर्न है, नियम नहीं. फासला कभी थोड़ा घटा है, कभी बढ़ा है, और आधिकारिक तारीख अभी घोषित नहीं हुई है।
      </p>
      <p>
      ...
      <p>
        यह आम बात है। जिस दिन घोषणा होती है, करोड़ों लोग एक साथ एक ही page खोलते हैं. Site धीमी, OTP
        देर से, कभी error। नाम कटने का इशारा नहीं है यह। सुबह जल्दी या रात में दोबारा
      ...
      <p>
        तो पहले वजह पकड़िए, फिर इलाज। श्रेणियां तीन ही हैं। पहली, document की कमी
        (eKYC, बैंक, जमीन)। ऊपर वाले चार काम कर लीजिए, अगली सूची में लौटने की गुंजाइश बन जाती है। दूसरी —
