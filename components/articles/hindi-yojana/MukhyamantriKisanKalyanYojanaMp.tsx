...
// Structure variant: timeline-rail release record + themed FAQ groups (दो हिस्सों में बंटे सवाल) (Rule 3)।
  ...
  return (
    <>
      ...
      <p>
        ...
        <Link href="/articles/hindi/farmer-id-card-kaise-banaye-online">इस page पर अलग से</Link> है।
      </p>
      <p>
      ...
      <div className="mt-8 p-5 bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-2xl">
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-sm">
          <li>
            <Link href="/articles/hindi/namo-shetkari-yojana-12000-kist">🌾 नमो शेतकरी योजना Maharashtra</Link>
          </li>
          <li>
