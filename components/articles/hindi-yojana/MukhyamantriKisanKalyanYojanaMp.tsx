...
export default function MukhyamantriKisanKalyanYojanaMp({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <FAQBlock faqs={FAQS} variant="cards" />

      <SH>सब मिलाकर बात इतनी सी है</SH>
      <p>
      ...
      <p>
        इसलिए साल में दो बार — बुवाई से पहले और कटाई के बाद — saara portal और pmkisan.gov.in दोनों
        पर अपना status देख लेना सबसे सस्ता बीमा है। कोई flag दिखे तो उसी हफ्ते पटवारी या बैंक branch का
