...
// Structure variant: decision-tree (तीन रास्ते) + case-file कहानियां + day-by-day timeline + dotted-card FAQ (Rule 3)।
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Online refund में जितनी किस्तें चुनेंगे उतनी ही लौटती हैं — हिस्सों में लौटाना तकनीकी रूप से संभव है। पर district recovery के मामलों में शर्तें स्थानीय प्रशासन तय करता है, वहीं से लिखित में पूछना ठीक रहेगा।',
  },
  {
    ...
    <>
      ...
      <div className="my-4">
        ...
        <Day label="महीना 2">
          ...
          दिया, received-मुहर ली — मामला वहीं बंद।
        </Day>
      </div>
      <p>
