  ...
  return (
    <>
      ...
      <PathCard badge="C" title="CSC पर उंगलियों के निशान से. जब OTP का रास्ता बंद हो">
        ...
        <p>
          दो सावधानियां। पहली. वहां भी सेवा की तय फीस मामूली ही होती है। मनमानी रकम मांगे तो सवाल कीजिए।
          दूसरी. काम होते ही counter पर status खुलवाकर eKYC: YES अपनी आंखों से देख लीजिए। "हो गया" सुनकर लौट आए,
          बाद में पता चला कि दर्ज ही नहीं हुआ था — यह शिकायत बहुत आम है।
        </p>
      </PathCard>
      ...
      <p>
        तीनों अलग-अलग दफ्तरों के काम हैं। और तीनों का YES चाहिए। eKYC हो गई तो सब पूरा. ऐसा
        मान लेना गलती है। खाते वाला हिस्सा विस्तार से{' '}
