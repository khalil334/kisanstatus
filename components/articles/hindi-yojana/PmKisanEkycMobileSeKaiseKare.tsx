    ...
    <>
      ...
      <ul className="list-none pl-0 space-y-3 my-4">
        ...
        <li className="border border-[var(--color-border)] rounded-xl p-4 text-sm leading-relaxed">
          ...
          पहले <Link href="/articles/hindi/pm-kisan-status-check-mobile-number-se">status</Link> देखकर पक्का कीजिए कि आप
          registered हैं या नहीं; न हों तो{' '}
          <Link href="/articles/hindi/pm-kisan-nayi-registration-kaise-kare">नई registration</Link> पहला कदम है।
        </li>
        <li className="border border-[var(--color-border)] rounded-xl p-4 text-sm leading-relaxed">
      ...
      <p>
        ...
        <Link href="/articles/hindi/npci-aadhaar-seeding-dbt-payment">NPCI आधार सीडिंग वाले लेख</Link> में पढ़ सकते हैं।
      </p>
      ...
      <p>
        ...
        <Link href="/articles/hindi/pm-kisan-status-check-mobile-number-se">status page</Link> खोलकर eKYC: YES देख लें। YES
      ...
      <p>
        ...
        दर्ज होती है, यह{' '}
        <Link href="/articles/hindi/pm-kisan-helpline-number-shikayat">हेल्पलाइन वाले page पर खुलेगा</Link>। जितनी जल्दी
      ...
      <div className="mt-8 p-5 bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-2xl">
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-sm">
          ...
          <li>
            <Link href="/articles/hindi/pm-kisan-status-check-mobile-number-se">📱 मोबाइल से स्टेटस चेक</Link>
          </li>
          <li>
