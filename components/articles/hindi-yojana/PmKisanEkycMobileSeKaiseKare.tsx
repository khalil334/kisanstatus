...
const FAQS = [
  ...
  },
  {
    ...
    a: 'eKYC तीन शर्तों में से एक है। बाकी दो — बैंक खाते की आधार seeding और जमीन के record की seeding — भी YES होनी चाहिए। इनमें कोई NO है तो भुगतान वहीं रुकेगा। Status page पर तीनों field एक साथ दिखते हैं, वहां मिला लीजिए।',
  },
  {
  ...
  return (
    <>
      ...
      <p>
        ...
        किया जाता है कि जिस नाम पर पैसा जा रहा है, वह व्यक्ति वाकई वही है। कागज पर नाम मिलाने के बजाय
      ...
      <p>
        ...
        लीजिए और तारीख डायरी में लिख लीजिए। कभी record में गड़बड़ी दिखे या किसी दफ्तर में सवाल उठे, तो यह
        सबूत झटपट काम करता है। कागज संभालना गांव में सस्ता बीमा है।
      </p>
      <p>
