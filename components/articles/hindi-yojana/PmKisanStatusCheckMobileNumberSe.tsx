...
function Step({ n, children }: { n: number; children: React.ReactNode }) {
  return (
    <li className="flex gap-3 items-stretch list-none mb-2">
      ...
      <div className="flex-1 bg-[var(--color-card)] border border-[var(--color-border)] rounded-xl px-4 py-3 text-sm text-[var(--color-text)] leading-relaxed shadow-sm mb-1">
        {children}
      </div>
    </li>
  );
  ...
  return (
    <>
      ...
      <p>
        ...
        एक जैसी उलझन। अच्छी बात — portal ने इसका रास्ता रखा है। आपका registered mobile number ही चाबी है: उसी से
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-[var(--color-bg-alt)]">
              ...
              <th className="border border-[var(--color-border)] p-2 text-left">YES हो तो</th>
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-[var(--color-bg-alt)]">
              ...
              <th className="border border-[var(--color-border)] p-2 text-left">आपके लिए इसका आशय</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-[var(--color-border)] p-2">
                <Link href="/articles/hindi/pm-kisan-payment-stopped-by-state-fix">वजह पकड़ें और सुधार कराएं</Link>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-[var(--color-border)] p-2">
                <Link href="/articles/hindi/pm-kisan-ekyc-mobile-se-kaise-kare">phone से eKYC कर लें</Link>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-[var(--color-border)] p-2">
                <Link href="/articles/hindi/npci-aadhaar-seeding-dbt-payment">बैंक में NPCI seeding कराएं</Link>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <p>
        ...
        <Link href="/articles/hindi/pm-kisan-ekyc-mobile-se-kaise-kare">यहां detail में पढ़ सकते हैं</Link>। जितनी जल्दी
      ...
      <p>
        ...
        <Link href="/articles/hindi/npci-aadhaar-seeding-dbt-payment">NPCI आधार सीडिंग guide</Link> देखें।
      </p>
      ...
      <ol className="space-y-0 my-4">
        ...
        <Step n={4}>
          ...
          <Link href="/articles/hindi/pm-kisan-nayi-registration-kaise-kare"> नई registration की प्रक्रिया</Link> देखिए और
      ...
      <div className="my-4 p-4 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-r-xl text-sm text-[var(--color-text)] leading-relaxed">
        ...
        <Link href="/articles/hindi/pm-kisan-helpline-number-shikayat">इस page पर समझाई</Link> है।
      </div>
