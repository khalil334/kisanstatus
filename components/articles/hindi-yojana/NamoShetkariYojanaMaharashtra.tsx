  ...
  return (
    <>
      ...
      <p>
        ...
        <Link href="/articles/hindi/mukhyamantri-kisan-kalyan-yojana-mp">किसान कल्याण योजना</Link> से शुरू किया था —
      ...
      <p>
        8वीं किस्त का किस्सा ध्यान से सुनिए, क्योंकि इसमें योजना की पूरी कार्यप्रणाली दिखती है। 17 मार्च 2026
      ...
      <ol className="my-4 space-y-3 pl-5 list-decimal text-sm leading-relaxed">
        <li>
          ...
          करें — पूरा तरीका <Link href="/articles/hindi/pm-kisan-ekyc-mobile-se-kaise-kare">यहां खुलेगा</Link>।
        </li>
        <li>
          ...
          <Link href="/articles/hindi/npci-aadhaar-seeding-dbt-payment">इस page पर समझाया है</Link>।
        </li>
        <li>
        ...
        <li>
          ...
          <Link href="/articles/hindi/pm-kisan-status-check-mobile-number-se">mobile number से status check</Link>) और वह
          ठीक कराएं।
        </li>
      </ol>
      ...
      <p>
        ...
        <Link href="/articles/hindi/pm-kisan-nayi-registration-kaise-kare">नई रजिस्ट्रेशन वाले लेख</Link> में देख लें।
      </p>
      ...
      <div className="mt-8 p-5 bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-2xl">
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-sm">
          <li><Link href="/articles/hindi/mukhyamantri-kisan-kalyan-yojana-mp">🌾 MP किसान कल्याण योजना ₹12000</Link></li>
