    ...
    <>
      ...
      <Milestone tag="पड़ाव 0" title="पहले Farmer ID बनवाइए">
        <p>
          ...
          <Link href="/articles/hindi/farmer-id-card-kaise-banaye-online">फार्मर आईडी कैसे बनाएं</Link> में step-by-step
      ...
      <p>
        ...
        <Link href="/articles/hindi/pm-kisan-25vi-kist-kab-aayegi">अगली किस्त वाला लेख</Link> पढ़ लें।
      </p>
