...
const FAQS = [
  {
    ...
    a: 'नहीं, registration साल भर खुली रहती है। लेकिन verification में समय लगता है. जितनी जल्दी apply करेंगे, अगली किस्त में नाम आने के उतने ज्यादा chances।',
  },
  {
  ...
  },
  {
    ...
    a: 'हां, और यही सही है। जमीन जिसके नाम, apply भी उसी का. चाहे वह घर की महिला हों। आधार, बैंक खाता और mobile OTP भी उन्हीं का चाहिए। पति अपने नाम से apply नहीं कर सकता जब तक खतौनी में उसका नाम न हो।',
  },
  {
  ...
  },
  {
    ...
    a: 'घबराएं नहीं. Portal पर Status of Self Registered Farmer में आधार नंबर से भी record खुल जाता है। आगे के लिए number का screenshot लेकर परिवार के किसी दूसरे phone पर भी भेज दें।',
  },
];
  ...
  return (
    <>
      ...
      <p>
        ...
        का काम है और इसके बिना आगे कुछ नहीं होगा। सवाल 2-3 पर जवाब “ना” है तो form भरना बेकार है. जांच में
      ...
      <Milestone tag="पड़ाव 0" title="पहले Farmer ID बनवाइए">
        ...
        <p>
          यह उलझन बहुत किसानों की है, तो साफ कर दें। Farmer ID (AgriStack) आपकी खेती की सरकारी पहचान है।
          इसके बनने से पैसा नहीं आता। ₹6,000 वाली योजना में नाम जोड़ने का आवेदन. PM Kisan registration. अलग
          चीज है। क्रम यह है: पहले Farmer ID, फिर उसी के सहारे PM Kisan का आवेदन। सिर्फ Farmer ID बनवाकर
          किस्त का इंतजार? वह कभी खत्म नहीं होगा। दोनों काम चाहिए।
        </p>
      </Milestone>
      ...
      <Milestone tag="पड़ाव 1" title="Documents की तैयारी">
        ...
        <p>
          ...
          है। यह काम पहले किए बिना अर्जी डालना टेढ़ी नींव पर दीवार उठाने के बराबर है।
        </p>
      </Milestone>
      ...
      <p>
        Status में Approved दिखना आधी जीत है। पूरी नहीं। पैसा आने के लिए तीन चीजें एक साथ हरी चाहिए:
        आवेदन approved, eKYC: YES, और बैंक खाते की आधार seeding active। तीनों हरी हैं तो नाम अगली
        release की beneficiary list में जुड़ता है, और उसी किस्त से पैसा शुरू। एक बात और. पुरानी
        किस्तों का arrear नए लाभार्थी को नहीं मिलता; गिनती आपके शामिल होने के बाद वाली किस्तों से होती
      ...
      <p>
        कितना इंतजार सामान्य है और कब पैरवी शुरू करनी चाहिए. यह समझना जरूरी है। मोटा नियम: apply करने के बाद
        एक-दो महीने तक status का Pending दिखना आम बात है, घबराने की जरूरत नहीं। लेकिन अगर दो महीने बाद भी
        अर्जी उसी जगह खड़ी है, तो समझिए कहीं मिलान अटका है और अब आपकी पैरवी के बिना वह आगे नहीं बढ़ेगी।
      </p>
      <p>
        पैरवी का तरीका भी सीधा है। पहले status में देखिए अर्जी किस स्तर पर अटकी है. District लिखा है तो
