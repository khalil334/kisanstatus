...
const RELATED = [
  ...
  { slug: 'pm-kisan-beneficiary-list-2026', title: 'Beneficiary Roster 2026', emoji: '📋' },
...
const FAQS_DATA = [
  { q: '500ml bottle ki price India mein 2026 kya hai?', a: 'Lagbhag ₹250-350. Subsidy ke saath ₹200-280 tak mil sakta hai. Exact price authorized dealer ya IFFCO website se confirm karein — state aur season ke hisaab se vary hota hai.' },
  { q: 'IFFCO liquid DAP aaj ka rate kya hai?', a: 'Authorized dealers par ₹280-320 ke beech. Subsidized rate kuch states mein ₹220-270. Latest price IFFCO official website ya nazdeeki Krishi Kendra se check karein.' },
  { q: '1 acre ke liye foliar dosage kitna hai?', a: 'Label ke anusaar 500ml per acre, 100-150 litre paani mein mila kar 2-3 baar spray. Exact dosage crop type aur KVK recommendations ke hisaab se alag ho sakta hai.' },
  { q: 'Traditional DAP se kya farak hai?', a: 'Liquid DAP foliar spray hai — nano particles seedha pattiyon se absorb hote hain. Traditional DAP granular soil application hai. Kai experts dono ka combination recommend karte hain — substitute nahi, supplement hai.' },
  { q: 'Urea ya pesticide ke saath mix kar sakte hain?', a: 'Compatibility test zaroori hai. Chhote area par pehle test karo. Kisi bhi mix ke liye KVK ya IFFCO guidelines follow karna safest hai. Galat mix se effectiveness kam hoti hai ya crop damage ho sakta hai.' },
  { q: 'Result kitne din mein dikhta hai?', a: 'Spray ke 7-10 din mein initial farak dikhna shuru ho sakta hai. 2-3 sprays ke baad clearer result. Soil condition, mausam, crop type, aur sahi usage par depend karta hai — fixed guarantee nahi.' },
      ...
      <div className="bg-[var(--color-primary)] py-8">
        <div className="container-site max-w-3xl">
          <nav className="text-green-200 text-xs mb-3 flex flex-wrap gap-1 items-center">
            ...
            <span>/</span>
            <span className="text-white font-bold">Modern Agri Inputs</span>
          </nav>
      ...
      <div className="container-site max-w-3xl py-8">
        ...
        <div className="my-6 p-5 bg-green-50 dark:bg-green-900/20 border-2 border-green-400 dark:border-green-700 rounded-xl">
          ...
          <p className="text-sm text-green-800 dark:text-green-300 leading-relaxed">
            <strong>Price:</strong> ₹250-350 (subsidy ke saath ₹200-280). <strong>Dosage:</strong> 500ml per acre, 100-150L paani mein, 2-3 sprays. <strong>Note:</strong> Exact price aur dosage authorized dealer ya KVK se confirm karein — yeh estimated reference hai.
          </p>
        </div>
        ...
        <section className="mb-8">
          ...
          <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-4">
            IFFCO ka advanced liquid fertilizer. Nano-scale particles jo foliar spray se seedha pattiyon se absorb hote hain. Traditional DAP mitti mein jaata hai, yeh hawa se patti tak.
          </p>
          <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-4">
          ...
          <IB>
            <strong>Honest Disclaimer:</strong> Koi fixed yield guarantee nahi hai. Yeh guide estimated prices aur general dosage batati hai. Apne local KVK ki advice hamesha priority rakhein.
          </IB>
        </section>
        ...
        <section className="mb-8">
          ...
          <WB>
            <strong>Note:</strong> Yeh June 2026 ki estimated values hain. Actual price state, dealer, subsidy policy, aur season ke hisaab se badalta rehta hai.
          </WB>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-[var(--color-text-muted)] text-sm leading-relaxed mb-4">
            Haryana, Punjab, UP, Maharashtra, Gujarat mein demand zyada = better availability. Eastern states mein supply chain slower hai.
          </p>
          <div className="overflow-x-auto my-4 rounded-xl border border-[var(--color-border)] shadow-sm">
            <table className="w-full text-sm border-collapse">
              <thead>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            {[
              { title: 'State Subsidies', desc: 'Har state ka structure alag. Kuch direct subsidy dete hain.' },
              ...
              { title: 'Original vs Duplicate', desc: 'IFFCO original thoda mehnga — quality verified. Sasta = risk.' },
            ].map(({ title, desc }) => (
        ...
        <section className="mb-8">
          ...
          <DB>
            <strong>Reminder:</strong> In benefits ka asar fasal, soil, paani, aur sahi usage par depend karta hai. Har khet mein result alag. Fixed guarantee nahi.
          </DB>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
            {[
              ...
              { title: 'Yield Mein Sambhavit Sudhar', desc: 'Kuch cultivators ne improvement report ki — guaranteed nahi.' },
        ...
        <section className="mb-8">
          ...
          <WB>
            <strong>Important:</strong> General reference only. Exact dosage IFFCO label aur local KVK se confirm karein. Overdose se crop damage ho sakta hai.
          </WB>
          <div className="overflow-x-auto my-4 rounded-xl border border-[var(--color-border)] shadow-sm">
            <table className="w-full text-sm border-collapse">
              <thead>
        ...
        <section className="mb-8">
          ...
          <StepList>
            <SI n={1}>500ml product ko 100-150L paani mein mix karo. 15L pump mein 50-75ml</SI>
            <SI n={2}>Bottle achhe se shake karo — nano particles evenly mix hone chahiye</SI>
            <SI n={3}>Subah ya shaam spray karo — dopahar ki garmi mein avoid</SI>
          ...
          <IB>
            <strong>Tip:</strong> Fine spray nozzle use karo — absorption behtar hoti hai. Coarse droplets waste hote hain.
          </IB>
        </section>
        ...
        <section className="mb-8">
          ...
          <DB>
            <strong>Sachai:</strong> Liquid DAP traditional DAP ka replacement nahi hai. Dono ka sahi combination best results deta hai. Sirf liquid par depend mat karo.
          </DB>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            {[
              { src: 'IFFCO Official Website', note: 'Sabse trustworthy. Original product guarantee.' },
              ...
              { src: 'Local Authorized Dealer', note: 'Most cultivators prefer offline. Receipt lo.' },
            ].map(({ src, note }) => (
        ...
        <section className="mb-8">
          ...
          <div className="space-y-2">
            {[
              'Zyada quantity = crop jal sakta hai. Label follow karo.',
        ...
        <div className="my-8 p-6 bg-green-50 dark:bg-green-900/20 border-2 border-green-400 dark:border-green-700 rounded-2xl">
          ...
          <p className="text-sm text-green-800 dark:text-green-300 leading-relaxed mb-3">
            Liquid DAP convenient option hai — kam quantity, easy application. Lekin akela kaam nahi karta. Sahi beej, samay par paani, aur balanced nutrition zaroori hai.
          </p>
