...
const FAQS = [
  ...
  },
  {
    ...
    a: 'नही। कोई portal, कोई form. कुछ भी नही है, और यही सबसे बडी गलतफहमी internet पर फैली हुई है। चयन DAY-NRLM में registered महिला SHG में से होता है. राज्य का livelihood mission, कृषि विभाग और fertilizer कंपनियां मिलकर करती हैं। आपको बस block के mission office मे समूह की रुचि दर्ज करानी है।',
  },
  {
    q: 'Training कितने दिन की है और कौन कराता है?',
    a: 'कुल 15 दिन, मुफ्त। पहले 5 दिन DGCA से मान्यता प्राप्त संस्थान (RPTO) में pilot training. पास होने पर Remote Pilot Certificate। बाकी 10 दिन खेती का practical। समूह की एक और सदस्य को assistant/technician की अलग training मिलती है।',
  },
  {
