...
const FAQS_PAISA = [
  {
    q: 'MP में PM Kisan और राज्य मिलाकर कुल कितना मिलता है?',
    a: 'सालाना ₹12,000. PM Kisan के ₹6,000 + राज्य के ₹6,000। दोनों DBT से सीधे खाते में।',
  },
  {
    q: 'MP की किस्तें साल में कब-कब आती हैं?',
...
const FAQS_HAQDARI = [
  ...
  },
  {
    ...
    a: 'नहीं। PM Kisan परिवार-आधारित है (पति-पत्नी-नाबालिग बच्चे = एक इकाई), किसान कल्याण उसी ढांचे पर चलती है। दोनों ने लिया तो recovery notice आ सकता है।',
  },
  {
  ...
  },
  {
    ...
    a: 'जमीन पूरी बिक गई तो eligibility खत्म. लाभ लेते रहे तो वसूली का जोखिम। नई जमीन दूसरी तहसील/जिले में ली है? नया land record PM Kisan में update कराइए, काम पटवारी/तहसील से होता है।',
  },
];
...
export default function MukhyamantriKisanKalyanYojanaMp({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <p>
        इस timeline से दो काम की बातें निकलती हैं। पहली. तारीखें fixed calendar से नहीं, सरकारी
        कार्यक्रमों (कृषि महोत्सव, जयंती) से जुड़ी होती हैं। पड़ोसी को आ गई, आपको नहीं? घबराने की
        बात तभी है जब release हो चुकी हो और आपकी entry में दिक्कत हो।
      ...
      <div className="my-5 border-2 border-[var(--color-border)] rounded-2xl overflow-hidden bg-[var(--color-card)] shadow-sm">
        <div className="bg-green-50 dark:bg-green-900/20 border-b border-[var(--color-border)] px-4 py-2.5">
          <span className="text-green-700 dark:text-green-300 text-xs font-bold">
             गाइड पूरी हुई. अब सीधे सरकारी पोर्टल पर:
          </span>
        </div>
