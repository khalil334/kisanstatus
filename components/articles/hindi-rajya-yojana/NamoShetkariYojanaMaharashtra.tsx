...
const FAQS = [
  ...
  },
  {
    ...
    a: 'तीन आम कारण: eKYC अधूरी, खाता आधार से linked/DBT-enabled नहीं, land record verification pending। चौथा, schedule: राज्य की किस्तें अपने कार्यक्रम से आती हैं, PM Kisan के साथ नहीं। NSMNY portal देखें, फिर कृषि सहायक/तलाठी।',
  },
  {
  ...
  },
  {
    ...
    a: 'DBT का पैसा NPCI mapper से तय होता है — जो खाता सबसे बाद में seed हुआ, रकम वहीं। जिस खाते में पैसा चाहिए, उसी branch में NPCI seeding form भरिए। बंद खाते वाला transfer fail होकर अगले cycle में री-ट्राई होता है।',
  },
  {
  ...
  },
  {
    ...
    a: 'नहीं। योजना PM Kisan के नियमों पर चलती है. जमीन का record जिनके नाम, उन्हीं के लिए। बटाईदारी का प्रावधान नहीं।',
  },
];
...
export default function NamoShetkariYojanaMaharashtra({ article }: { article: HindiArticle }) {
  return (
    <>
      ...
      <p>
        सीधा जवाब पहले: 8वीं किस्त मार्च 2026 में खातों में गई थी, और इस लेख की आखिरी जांच तक 9वीं
        किस्त का कोई आधिकारिक GR या तारीख घोषित नहीं हुई थी। पिछला ढर्रा यही रहा है. करीब चार
        महीने का फासला, और कई बार PM Kisan की किस्त के आसपास release। यानी इंतजार स्वाभाविक है,
        घबराहट नहीं. देरी इस योजना में नयी बात नहीं है (8वीं किस्त भी अपनी अवधि से करीब चार महीने
        बाद आई थी)। पक्की खबर सिर्फ दो जगह से मिलेगी. राज्य सरकार का GR/घोषणा और{' '}
        <a href="https://nsmny.mahait.org" target="_blank" rel="noopener noreferrer">nsmny.mahait.org</a> का
        Beneficiary Status। WhatsApp पर घूमती तारीखों का कोई आधार नहीं होता। इस बीच आपके हाथ में जो
        काम है. EKYC, बैंक seeding, land record. वह नीचे checklist में है; घोषणा के दिन वही तय करेगा
        कि पैसा आपके खाते तक पहुंचेगा या अटकेगा।
      </p>
      ...
      <p>
        महाराष्ट्र में गांव स्तर पर दो अलग सरकारी कर्मचारी इस योजना से जुड़े हैं। गलत आदमी के पास गए तो
        सिर्फ समय जाएगा। <strong>तलाठी</strong> राजस्व विभाग का आदमी है. 7/12, 8-अ, नामांतरण (फेरफार),
