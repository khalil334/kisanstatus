...
const FAQS = [
  {
    ...
    a: 'हां। केंद्र ₹6,000 भेजता है, राज्य अपना हिस्सा ऊपर जोड़ता है — पोर्टल अलग, तारीखें अलग। बस MP-महाराष्ट्र में सूची PM Kisan के डेटा से बनती है।',
  },
  {
  ...
  return (
    <>
      ...
      <p>
        ...
        Kisan जैसी अलग सालाना नकद-सहायता योजना अभी नहीं चल रही। इन राज्यों के किसानों को अक्सर
        यह सवाल परेशान करता है कि पड़ोसी राज्य में अलग किस्त मिलती है तो हमारा नंबर कब आएगा।
        जवाब यह है कि यहां मदद का मॉडल ही अलग है:
      </p>
