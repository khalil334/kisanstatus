...
const RELATED_ARTICLES = [
  {
    title: 'PM Kisan 23vi Kist Status Check',
    slug: '/articles/pm-kisan-23vi-kist-2026-status-check',
    emoji: '📆',
    desc: 'Apni 23vi kist ka status check karein',
  },
  {
    title: 'PM Kisan eKYC Online 2026',
    slug: '/articles/pm-kisan-ekyc-online-2026',
    emoji: '🔐',
    desc: 'eKYC complete karein - bilkul free',
  },
  {
    title: 'Soil Health Card Complete Guide',
    slug: '/articles/soil-health-card-complete-guide-2026',
    emoji: '🌱',
    desc: 'Mitti health card download karein',
  },
  {
    title: 'PM Kisan Payment Failed Solution',
    slug: '/articles/pm-kisan-payment-failed-status-2026',
    emoji: '💸',
    desc: 'Payment fail hone par kya karein',
  },
];
...
const getSchema = () => ({
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://kisanstatus.com/articles/mandi-bhav-today',
  },
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Aaj ka mandi bhav: Aloo ₹20-24/kg, Pyaaz ₹26-30/kg, Tamatar ₹38-45/kg, Seb ₹130-160/kg, Kela ₹48-58/dozen. Ye wholesale mandi rates hain.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Aaj aloo ka bhav ₹20-24 per kg hai wholesale mandi mein. Kal ka rate ₹18 tha, aaj ₹2 badha hai.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Aaj pyaaz ka rate ₹26-30 per kg hai. Kal ke mukable ₹2 kam hua hai.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Aaj tamatar ka bhav ₹38-45 per kg hai wholesale mandi mein. Kal se ₹5 badha hai.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Fruit mandi bhav aap yahan check kar sakte hain. Seb ₹130-160/kg, Kela ₹48-58/dozen, Santra ₹85-105/kg, Aam ₹160-220/kg.',
      },
    },
  ],
});
...
export default function MandiBhavContent() {
  ...
  // Calculator States
  const [pmKisanCalc, setPmKisanCalc] = useState({
    years: 1,
    totalAmount: 6000,
  });
  
  const [mandiCalc, setMandiCalc] = useState({
    quantity: 100,
    rate: 25,
    cost: 1500,
    profit: 1000,
  ...
  const calculatePmKisan = (years: number) => {
    const total = years * 6000;
    setPmKisanCalc({ years, totalAmount: total });
  };
  ...
  const calculateMandiProfit = (qty: number, rate: number, cost: number) => {
    ...
    setMandiCalc({ quantity: qty, rate, cost, profit });
  };
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-black">
                Aaj Ka Mandi Bhav 30 June 2026 - Sabzi aur Fruit Rates Today
              </h1>
              <p className="text-green-100 text-sm mt-2">
                Last Updated: {MANDI_DATA.lastUpdated} {currentTime && `at ${currentTime}`}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Introduction - Long-tail Keywords */}
        ...
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 flex items-center gap-2">
            ...
            Aaj Ke Sabzi Bhav - Vegetable Rates Today
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {MANDI_DATA.vegetables.map((veg, index) => (
              <div 
                key={index}
                className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-5 border-2 border-green-100"
              >
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-bold text-gray-900 text-lg">{veg.name}</h3>
                  <span className={`text-xs font-bold px-2 py-1 rounded-full ${
                    veg.trend === 'up' ? 'bg-red-100 text-red-700' :
                    veg.trend === 'down' ? 'bg-green-100 text-green-700' :
          ...
          {/* Vegetable Images - CORRECTED PATHS */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-vegetables-potato-onion.webp"
                alt="Aloo aur Pyaaz - Potato and Onion in Mandi"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
                आलू और प्याज
              </div>
            </div>
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-vegetables-tomato-carrot.webp"
                alt="Tamatar aur Gaajar - Tomato and Carrot Fresh"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
            ...
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-fresh-vegetables-mixed.webp"
                alt="Tazi Sabziyan - Fresh Mixed Vegetables Market"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
        ...
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 flex items-center gap-2">
            <span className="text-3xl">🍎</span>
            Fruit Mandi Bhav - Phalon Ke Rates Today
          </h2>
          <p className="text-gray-600 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {MANDI_DATA.fruits.map((fruit, index) => (
              <div 
                key={index}
                className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-5 border-2 border-amber-100"
              >
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-bold text-gray-900 text-lg">{fruit.name}</h3>
                  <span className={`text-xs font-bold px-2 py-1 rounded-full ${
                    fruit.trend === 'up' ? 'bg-red-100 text-red-700' :
                    fruit.trend === 'down' ? 'bg-green-100 text-green-700' :
                    'bg-gray-100 text-gray-700'
                  }`}>
          ...
          {/* Fruit Images - CORRECTED PATHS */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-fruits-apple-banana.webp"
                alt="Seb aur Kela - Apple and Banana Fresh"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
            ...
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-fruits-mango-orange.webp"
                alt="Aam aur Santra - Mango and Orange"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
            ...
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/article/mandi-fresh-fruits-mixed.webp"
                alt="Taze Phal - Fresh Mixed Fruits Market"
                fill
                className="object-cover hover:scale-110 transition-transform"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-2 text-sm font-bold">
        ...
        <section className="mb-12 bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-black text-gray-900 mb-4 flex items-center gap-2">
            <span className="text-3xl">📍</span>
            State-wise Mandi Bhav - Major Cities
          </h2>
        ...
        {/* CALCULATOR 1: PM Kisan Benefit Calculator */}
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <div className="mb-4">
              <label className="block text-sm font-bold text-gray-700 mb-2">
                Kitne saal tak PM Kisan lenge?
              </label>
              <input
                type="range"
                min="1"
                max="10"
                value={pmKisanCalc.years}
                onChange={(e) => calculatePmKisan(Number(e.target.value))}
            ...
            <div className="bg-green-100 rounded-xl p-4 text-center">
              ...
              <div className="text-4xl font-black text-green-700">
                ₹{pmKisanCalc.totalAmount.toLocaleString('en-IN')}
              </div>
              <div className="text-xs text-gray-500 mt-2">
                ({pmKisanCalc.years} saal × ₹6,000 per year)
              </div>
            </div>
        ...
        {/* CALCULATOR 2: Mandi Profit Calculator */}
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <input
                  type="number"
                  value={mandiCalc.quantity}
                  onChange={(e) => calculateMandiProfit(
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-100 rounded-xl p-4 text-center">
                ...
                <div className="text-3xl font-black text-blue-700">
                  ₹{(mandiCalc.quantity * mandiCalc.rate).toLocaleString('en-IN')}
                </div>
              </div>
              
              <div className={`rounded-xl p-4 text-center ${
                mandiCalc.profit >= 0 ? 'bg-green-100' : 'bg-red-100'
              }`}>
                <div className="text-sm text-gray-600 mb-1">Net Profit</div>
                <div className={`text-3xl font-black ${
                  mandiCalc.profit >= 0 ? 'text-green-700' : 'text-red-700'
                }`}>
                  ₹{mandiCalc.profit.toLocaleString('en-IN')}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600">
                Aaj ka mandi bhav: Aloo ₹20-24/kg, Pyaaz ₹26-30/kg, Tamatar ₹38-45/kg, Seb ₹130-160/kg, 
                Kela ₹48-58/dozen. Ye wholesale mandi rates hain jo daily update hote hain.
              </p>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600">
                Aaj aloo ka bhav ₹20-24 per kg hai wholesale mandi mein. Kal ka rate ₹18 tha, aaj ₹2 badha hai.
              </p>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600">
                Aaj pyaaz ka rate ₹26-30 per kg hai. Kal ke mukable ₹2 kam hua hai.
              </p>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600">
                Aaj tamatar ka bhav ₹38-45 per kg hai wholesale mandi mein. Kal se ₹5 badha hai.
              </p>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600">
                Fruit mandi bhav aap yahan check kar sakte hain. Seb ₹130-160/kg, Kela ₹48-58/dozen, 
                Santra ₹85-105/kg, Aam ₹160-220/kg.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 mb-8 border-2 border-green-200">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>Subah 8-10 baje mandi visit karein - best rates milte hain</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">✓</span>
              <span>Wholesale mandi mein retail se 20-30% sasta milta hai</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">✓</span>
              <span>Seasonal sabziyon ke rates kam hote hain</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">✓</span>
              <span>Online mandi bhav apps bhi use kar sakte hain</span>
            </li>
          </ul>
        </section>
        ...
        <div className="text-center">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white font-bold px-8 py-3 rounded-xl transition-all hover:scale-105"
          >
            ← Wapas Home Page Par
          </Link>
        </div>
