...
const schemas = [{
  ...
  headline:'Cultivator Benefit Scheme 10 Common Roadblocks Guide 2026 — Har Issue Ka Real Solution',
  description:'Government welfare scheme ki 10 sabse common roadblocks — transfer request pending, treasury gateway error, direct credit fail, declined application, land record linking, identity mismatch — sab ka tested solution ek jagah.',
...
const PROBLEMS = [
  {
    ...
    explain:'RFT = Request For Transfer. "RFT Signed By State" = State government ne monetary release kar di — ab government financial gateway se bank mein credit transfer hogi. Yeh good news hai — paisa raste mein hai.',
    fix:'Kuch nahi karna — 3-7 working days mein bank mein credit ho jaayega. Screenshot lo aur wait karo. Agar 10 din baad nahi aaya to bank se national payment network mapper check karo.',
  ...
  },
  {
    ...
    mystery:'Treasury gateway successful dikhta hai lekin bank mein paisa nahi.',
    explain:'PFMS (Public Financial Management System) government ki credit transfer gateway hai. Treasury ne bank ko transfer bheja — lekin bank reject kar di ya bounce ho gayi. Yeh banking linkage system Aadhaar seeding issue hai 90% cases mein.',
    fix:'Bank branch jao → "Aadhaar banking linkage hai?" puchho → Nahi hai to form bharo (free) → 3-7 din mein link → Agli installment cycle mein credit + arrears.',
    articleHref: '/articles/pm-kisan-payment-failed-status-2026',
  },
  {
  ...
  },
  {
    ...
    explain:'3 reasons ho sakte hain: (1) Aadhaar/mobile number galat enter kiya, (2) Enrollment abhi pending hai state verification mein, (3) Enrollment kisi aur number se hua tha.',
    fix:'Pehle Aadhaar number dobara check karo — identity card se. Phir Mobile number try karo. Phir Enrollment ID (agar available hai). Kuch bhi kaam nahi kiya to helpline 155261 call karo — naam batao, woh check kar denge.',
    articleHref: '/articles/pm-kisan-beneficiary-list-2026',
  },
  {
    n:5, title:'Identity Roster Mein Hai Par Credit Transfer Nahi',
    tag:'Frustrating',
    tagColor:'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300',
    mystery:'Eligible recipients roster mein naam hai, status "Active" hai — phir bhi payout nahi.',
    explain:'Active status aur payment aana do alag cheezein hain. Credit transfer ke liye additionally: digital verification complete, bank Aadhaar banking linkage seeded, aur IFSC code sahi hona chahiye. Inme se koi ek missing ho to installment cycle bounce hoti hai.',
    fix:'Checklist: (1) Verification check karo — "Done" hona chahiye. (2) Bank branch mein national payment network mapper confirm karo. (3) IFSC code portal par verify karo passbook se. Teeno ok hai to helpline 155261 call karo.',
    articleHref: '/articles/pm-kisan-payment-failed-status-2026',
  },
  {
    ...
    explain:'3 common reasons: (1) Aadhaar number galat enter kiya, (2) OTP galat ya expire hua, (3) Identity record kisi problem mein hai (naam mismatch, locked Aadhaar).',
    fix:'Step 1: Aadhaar number dobara check karo. Step 2: OTP 30 second ke andar enter karo. Step 3: Agar baar baar fail ho — Aadhaar helpline 1947 call karo — identity record check karwao. Step 4: CSC biometric try karo — wahan OTP ki zaroorat nahi.',
    articleHref: '/articles/pm-kisan-ekyc-online-2026',
  },
  {
  ...
  {
    n:9, title:'Credit Transfer Doosre Ke Account Mein Gayi',
    tag:'Rare But Real',
    tagColor:'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300',
    mystery:'IFSC ya account number galat tha — paisa wrong account mein credit hua.',
    explain:'Yeh rare hai lekin hota hai. Scheme monetary release ek baar credit hone ke baad wapas nahi hoti directly — lekin process hai.',
      ...
      <div className="bg-[var(--color-primary)] py-8">
        <div className="container-site max-w-3xl">
          <nav className="text-green-200 text-xs mb-3 flex flex-wrap gap-1 items-center">
            ...
            <span className="text-white font-bold">10 Common Roadblocks Guide</span>
          </nav>
          <span className="inline-block bg-white/20 text-white text-xs font-bold px-3 py-1 rounded-full mb-3">🔧 10 Roadblocks</span>
          <h1 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3">
            Cultivator Benefit Scheme 10 Common Roadblocks 2026 — Har Ek Ka Real Solution Yahan Hai
          </h1>
      ...
      <div className="container-site max-w-3xl py-8">
        <div className="my-6 rounded-2xl overflow-hidden border border-[var(--color-border)] shadow-md">
          <img
            ...
            height="630"
          />
          <p className="text-center text-xs text-[var(--color-text-muted)] py-2 bg-[var(--color-bg-alt)] border-t border-[var(--color-border)]">10 Common Roadblocks — 10 Real Solutions 2026</p>
        </div>
        ...
        <div className="my-6 p-5 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-400 dark:border-blue-700 border-l-[6px] rounded-xl">
          ...
          <p className="text-sm text-blue-900 dark:text-blue-200 leading-relaxed">
            Neeche 10 roadblocks hain — apni roadblock ki number dhundho aur directly us section par jao. Har section mein: <strong>roadblock ka matlab</strong>, <strong>kyun hoti hai</strong>, aur <strong>exact fix steps</strong>. Specific roadblock ke liye detailed guide ka link bhi hai.
          </p>
          <p className="text-sm text-blue-900 dark:text-blue-200 leading-relaxed mt-2">Simple hai.</p>
        </div>
        ...
        <div className="mt-8 p-5 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl text-center">
          <p className="font-black text-green-900 dark:text-green-300 text-base mb-1">📞 Koi Roadblock Solve Nahi Hui?</p>
