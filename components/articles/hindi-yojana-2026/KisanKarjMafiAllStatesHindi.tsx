  ...
  return (
    <>
      ...
      <p>
        ...
        समय भी वह जवाब नहीं दे रहा था। इसे &ldquo;सर्वर पर लोड क्योंकि नई लिस्ट आ गई&rdquo; वाली अफवाह का
        सबूत नहीं मानना चाहिए। पोर्टल न खुले तो सीधे अपनी बैंक ब्रांच या तहसील में पता करें — रिकॉर्ड वहीं
        है। विस्तार से{' '}
      ...
      <p>
        ...
        <strong> confirm मत कीजिए</strong> — आपत्ति दर्ज करने का विकल्प होता है, उसका इस्तेमाल करें और बैंक
        से अपना statement लेकर मिलान करें। एक बार गलत रकम confirm हो गई तो सुधरवाना लंबा काम है। दूसरी —
      ...
      <p>
        और हां — कर्ज माफी के इंतजार में चल रही किस्त रोकना सबसे महंगा फैसला है। किस्त रुकती है तो ब्याज
        चढ़ता है, खाता NPA में जाता है, और अगला लोन बंद हो जाता है। नोटिस आ चुका है तो{' '}
