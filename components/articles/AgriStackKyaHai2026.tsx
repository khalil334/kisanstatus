...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "kisan registry enrollment hindi",
    "digital agriculture portal login",
    "kisan id se loan apply",
    "digital kisan status check",
    "kisan pehchaan benefit list",
    "kisan registry app download",
    "kisan id helpline 2026",
  ],
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "14 digit kisan pehchaan card download kaise kare 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Kisan registry mein enrollment free hai ya paid?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Kisan ID se KCC loan kaise apply kare?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Kisan ID helpline number kya hai?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Helpline numbers: 155261 (toll-free), 1800115526 (toll-free), 011-23382391 (landline). Timing: 9 AM to 6 PM (Monday-Saturday). Call karne se pehle apna Aadhaar number aur enrollment details ready rakhein.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kisan Pehchaan Guide", "item": "https://kisanstatus.com/articles/agristack-kya-hai" },
  ],
};
    ...
    <main className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
      ...
      <header className="mb-6">
        <h1 className="text-3xl md:text-4xl font-bold text-green-800 leading-tight mb-3">
          Kisan Pehchaan 2026: 14-Digit Digital ID Banwane Ka Pura Tarika
        </h1>
      ...
      <section id="id-details" className="mb-10">
        ...
        <p className="mb-4 leading-relaxed">
          Yeh ek <strong>14-digit unique identification number</strong> hai jo har registered beneficiary ko milta hai. <strong>Yeh Aadhaar ki tarah kaam karta hai</strong> lekin <strong>specifically agriculture ke liye</strong>.
        </p>
          ...
          <table className="w-full border-collapse border border-gray-300 text-sm">
            <thead>
              <tr className="bg-green-100">
                ...
                <th className="border border-gray-300 px-4 py-2 text-left">Kisan Pehchaan</th>
              </tr>
            </thead>
            <tbody>
              {[
                ["Purpose", "General citizen identity", "Agriculture-specific identity"],
        ...
        <p className="mb-4 leading-relaxed">
          <strong>Banwane ke liye kya chahiye?</strong> Aapka <strong>Aadhaar number required hai</strong>. Ek baar <strong>ID ban gayi</strong> toh aap <a href="/articles/pm-kisan-23vi-kist-2026-status-check" className="text-green-700 underline hover:text-green-900 font-semibold">PM Kisan</a>, <a href="/articles/pm-kisan-ekyc-online-2026" className="text-green-700 underline hover:text-green-900 font-semibold">eKYC</a>, <a href="/articles/pmfby-crop-insurance-2026" className="text-green-700 underline hover:text-green-900 font-semibold">crop insurance</a> aur baaki sab schemes seedha isi ID se access kar sakte ho.
        </p>
      ...
      <section id="registration-process" className="mb-10">
        ...
        <p className="mb-4 leading-relaxed">
          <strong>Agar online process mushkil lage</strong> ya <strong>internet ki problem ho</strong> toh apne <strong>nearest Common Service Centre (CSC)</strong> par jaayein. Wahan ka <strong>VLE (Village Level Entrepreneur)</strong> aapka enrollment kar dega.
        </p>
      ...
      <section id="state-status" className="mb-10">
        ...
        <p className="mb-4 leading-relaxed">
          Yeh ek <strong>central government initiative</strong> hai lekin iska <strong>implementation state governments ke saath milkar</strong> ho raha hai. Neeche <strong>current status</strong> diya gaya hai:
        </p>
      ...
      <section id="faq" className="mb-10">
        ...
        <div className="space-y-4">
          {[
            ...
            { q: "Kisan registry mein enrollment free hai ya paid?", a: "100% FREE hai - online portal aur CSC centre dono par. Government ne clearly bola hai ki koi fee nahi li jaayegi. Agar koi paisa maange toh helpline 155261 par complain karein." },
            { q: "Kisan ID se KCC loan kaise apply kare?", a: "Bank mein jaake apni 14-digit ID dikhayein. Aapki land records already verified hoti hain isliye KCC ya agricultural loan jaldi approve ho jaata hai. Pehle jaise mahino-mahine wait nahi karna padta." },
            ...
            { q: "Kisan ID helpline number kya hai?", a: "Helpline numbers: 155261 (toll-free), 1800115526 (toll-free), 011-23382391 (landline). Timing: 9 AM to 6 PM (Monday-Saturday). Call karne se pehle apna Aadhaar number ready rakhein." },
      ...
      <aside aria-label="About the Team" className="mb-10 border border-gray-200 rounded-xl p-5 bg-gray-50 flex gap-4 items-start">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-2">
            Verified information from official sources · Updated regularly
          </p>
        </div>
      </aside>
    </main>
