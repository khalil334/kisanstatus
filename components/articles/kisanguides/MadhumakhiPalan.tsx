...
const jsonLd = {
  ...
  '@graph': [
    ...
    { '@type': 'BreadcrumbList', '@id': 'https://kisanstatus.com/articles/madhumakhi-palan-kvic-subsidy/#breadcrumb', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://kisanstatus.com/' }, { '@type': 'ListItem', position: 2, name: 'Articles', item: 'https://kisanstatus.com/articles' }, { '@type': 'ListItem', position: 3, name: 'Madhumakhi Palan', item: 'https://kisanstatus.com/articles/madhumakhi-palan-kvic-subsidy' }] },
    { '@type': 'Article', '@id': 'https://kisanstatus.com/articles/madhumakhi-palan-kvic-subsidy/#article', headline: 'Madhumakhi Palan 2026: KVIC Subsidy, Profit & Complete Guide', description: 'Madhumakhi palan ka complete guide. Janein bee farming, KVIC subsidy, bee box price aur honey business ki ground reality.', author: { '@type': 'Organization', name: 'KisanStatus Team', url: 'https://kisanstatus.com/about' }, publisher: { '@type': 'Organization', name: 'KisanStatus.com', logo: { '@type': 'ImageObject', url: 'https://kisanstatus.com/logo.webp' } }, datePublished: '2026-01-15', dateModified: '2026-07-21', mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://kisanstatus.com/articles/madhumakhi-palan-kvic-subsidy/' } },
