 ...
 */
export default function NamoShetkariYojanaStatus({ article }: { article: RajyaYojanaArticleMeta }) {
  return (
    <article className="max-w-3xl mx-auto px-4 py-8 prose prose-lg dark:prose-invert">
      ...
      <p>Maharashtra Namo Shetkari Mahasanman Nidhi ka hapta aur status check — poori detail jald.</p>
