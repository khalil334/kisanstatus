 ...
 */
export default function RythuBharosaStatusCheck({ article }: { article: RajyaYojanaArticleMeta }) {
  return (
    <article className="max-w-3xl mx-auto px-4 py-8 prose prose-lg dark:prose-invert">
      ...
      <p>Telangana Rythu Bharosa ka per-acre paisa aur payment status — poori detail jald.</p>
