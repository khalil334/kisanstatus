 ...
 */
export default function AnnadataSukhibhavaStatusCheck({ article }: { article: RajyaYojanaArticleMeta }) {
  return (
    <article className="max-w-3xl mx-auto px-4 py-8 prose prose-lg dark:prose-invert">
      ...
      <p>Andhra Pradesh ke Annadata Sukhibhava scheme ka status check aur eligibility — poori detail jald.</p>
