 ...
 */
export default function OdishaCmKisanStatusCheck({ article }: { article: RajyaYojanaArticleMeta }) {
  return (
    <article className="max-w-3xl mx-auto px-4 py-8 prose prose-lg dark:prose-invert">
      ...
      <Fig
        src="hero.webp"
        alt="Odisha ke chhote kisan aur bhoomiheen khet mazdoor apne khet ke paas"
        caption="Odisha CM Kisan (purani KALIA) — chhote kisan aur bhoomiheen mazdooron ke liye"
        priority
      />

      <p>Odisha CM Kisan (purani KALIA) ka status aur beneficiary list — poori detail jald.</p>
