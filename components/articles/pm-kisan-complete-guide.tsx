      ...
      <div className="relative w-full h-64 md:h-96 mb-8 rounded-xl overflow-hidden shadow-2xl bg-gradient-to-br from-green-100 to-emerald-200">
        <Image
          ...
          onError={(e) => {
            ...
            target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'%3E%3Crect fill='%2310b981' width='400' height='300'/%3E%3Ctext fill='white' font-size='24' x='50%25' y='50%25' text-anchor='middle' dy='.3em'%3EPM Kisan Guide%3C/text%3E%3C/svg%3E";
          }}
        />
      ...
      <section className="mb-10">
        ...
        <div className="relative w-full h-48 md:h-64 mb-6 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-green-50 to-emerald-100">
          <Image
            ...
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 256'%3E%3Crect fill='%2310b981' width='400' height='256'/%3E%3Ctext fill='white' font-size='20' x='50%25' y='50%25' text-anchor='middle' dy='.3em'%3Ee-KYC Process%3C/text%3E%3C/svg%3E";
            }}
          />
        </div>
      ...
      <section className="mb-10">
        ...
        <div className="relative w-full h-48 md:h-64 mb-6 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-green-50 to-emerald-100">
          <Image
            ...
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 256'%3E%3Crect fill='%2310b981' width='400' height='256'/%3E%3Ctext fill='white' font-size='20' x='50%25' y='50%25' text-anchor='middle' dy='.3em'%3EPayment Success%3C/text%3E%3C/svg%3E";
            }}
          />
        </div>
