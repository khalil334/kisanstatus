  ...
  return (
    <figure style={figStyle}>
      <svg viewBox="0 0 900 400" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="110" y="370" fontSize="12" fill="#166534">21st Installment — ₹2,000 — 19 Nov 2025 — A/C: XXXX1234</text>
      </svg>
      <figcaption style={capStyle}>{caption}</figcaption>
    </figure>
  );
  ...
  return (
    <figure style={figStyle}>
      <svg viewBox="0 0 900 360" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="60" y="320" fontSize="13" fill="#15803d">✅ 21st Installment: Credited to Bank Account — 19 Nov 2025 — ₹2,000</text>
      </svg>
      <figcaption style={capStyle}>{caption}</figcaption>
    </figure>
  );
  ...
  return (
    <figure style={figStyle}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="450" y="155" textAnchor="middle" fontSize="13" fill="#64748b">21st PM Kisan Installment — 19 November 2025</text>
        <text x="450" y="178" textAnchor="middle" fontSize="13" fill="#64748b">Bank Account: XXXX XXXX 1234 | PFMS Ref: PM2025XXXX</text>
        {/* Status flow */}
        {[
  ...
  return (
    <figure style={figStyle}>
      <svg viewBox="0 0 900 260" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {[
          {q:'21vi kist kab aayegi?',a:'Nov 2025 mein aayi thi. 22vi date TBD.',x:40,y:70},
