  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 420" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="82" y="74" fontSize="16" fontWeight="bold" fill="#fff">PM Kisan Scheme</text>
        <text x="82" y="94" fontSize="12" fill="#a7f3d0">Ministry of Agriculture — Govt. of India</text>
        ...
        {['Home','About','Farmers Corner','Beneficiary Status','eKYC','New Enrollment','Contact'].map((t,i)=>(
        ...
        <text x="50" y="210" fontSize="26" fontWeight="bold" fill="#fff">PM Kisan Samman Nidhi</text>
        ...
        {[['11 Cr+','Registered Farmers'],['₹6,000','Annual Benefit'],['3','Kisten/Saal'],['DBT','Direct to Bank']].map(([v,l],i)=>(
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 400" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="450" y="32" textAnchor="middle" fontSize="18" fontWeight="bold" fill="#fff">PM Kisan — Beneficiary Verification</text>
        ...
        <text x="450" y="125" textAnchor="middle" fontSize="12" fill="#64748b">Aadhaar, Mobile Number ya Account Number se check karein</text>
        {[['Aadhaar',200],['Mobile Number',420],['Account Number',640]].map(([label,x],i)=>(
          <g key={String(label)}>
        ...
        <text x="110" y="370" fontSize="12" fill="#166534">23rd Kist — ₹2,000 — 20 Jun 2026 — A/C: XXXX1234</text>
      </svg>
      <figcaption style={capStyle}>{caption}</figcaption>
    </figure>
  );
    ...
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 360" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {[
          ...
          {n:'2',title:'Aadhaar Chuniye',desc:'Pehla option select karein',x:300,clr:'#0369a1'},
        ...
        <text x="60" y="320" fontSize="13" fill="#15803d">✅ 23rd Kist: Credited to Bank Account — 20 Jun 2026 — ₹2,000</text>
      </svg>
      <figcaption style={capStyle}>{caption}</figcaption>
    </figure>
  );
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 340" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="450" y="62" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#fff">📱 Mobile Number Se Status Verify</text>
        ...
        <text x="765" y="280" textAnchor="middle" fontSize="10" fill="#166534">Aadhaar se try</text>
        <text x="765" y="296" textAnchor="middle" fontSize="10" fill="#166534">karein ya</text>
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="275" y="128" textAnchor="middle" fontSize="10" fill="#fff">PM Kisan Portal</text>
        ...
        {[
          ...
          {x:530,y:60,t1:'Aadhaar Se',t2:'Verify Karo'},
          {x:680,y:60,t1:'3 Steps Mein',t2:'Status Pata Karo'},
          {x:380,y:170,t1:'eKYC Abhi',t2:'Karo'},
          {x:530,y:170,t1:'₹2,000 Per',t2:'Kist'},
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 340" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {['1. Official portal kholo','2. Farmers Corner → eKYC','3. Aadhaar number daalo','4. OTP aayega mobile par','5. OTP enter karo → Submit','✅ Instant complete!'].map((s,i)=>(
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        <text x="450" y="155" textAnchor="middle" fontSize="13" fill="#64748b">23rd PM Kisan Kist — 20 June 2026</text>
    ...
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 260" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {[
          ...
          {q:'eKYC kaise kare?',a:'Official portal → eKYC → Aadhaar + OTP',x:470,y:70},
          {q:'Status verify karne ke liye kya chahiye?',a:'Sirf Aadhaar ya mobile number',x:40,y:165},
          {q:'Payment nahi aayi to kya kare?',a:'Helpline: 155261 pe call karo',x:470,y:165},
        ].map(s=>(
          <g key={s.x+s.y}>
            <rect x={s.x} y={s.y} width="390" height="80" rx="10" fill="#fff" stroke="#e2e8f0" strokeWidth="1.5"/>
            <text x={s.x+20} y={s.y+26} fontSize="13" fontWeight="bold" fill="#1e293b">Q: {s.q}</text>
            <rect x={s.x} y={s.y+38} width="390" height="1" fill="#f1f5f9"/>
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {[
          {reason:'eKYC Pending',fix:'Official portal par eKYC complete karo',clr:'#dc2626'},
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {[
          {t:'State Govt.',sub:'Kisan list tayyar ki',clr:'#7c3aed',x:60},
...
export function SvgRegistrationId({ caption }: { caption: string }) {
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        <rect width="900" height="300" fill="#eff6ff"/>
        <text x="450" y="36" textAnchor="middle" fontSize="18" fontWeight="bold" fill="#1d4ed8">🔍 PM Kisan Enrollment ID Kaise Pata Karein</text>
        {[
          {method:'Aadhaar Se',steps:['Official portal kholo','Know Your Enrollment No.','Aadhaar number daalo','ID screen par dikhi'],clr:'#1d4ed8',x:40},
          {method:'Mobile Number Se',steps:['Official portal kholo','Beneficiary Status','Mobile number enter karo','Enrollment ID dikhi'],clr:'#0891b2',x:330},
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 280" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {['Step 1: Official portal → Farmers Corner → Updation of SR','Step 2: Aadhaar number se login karein','Step 3: Edit name field → Sahi naam daalo','Step 4: Aadhaar card ke EXACTLY saame spelling use karein','Step 5: Documents upload → Submit → 15-30 din wait karein'].map((s,i)=>(
  ...
  return (
    <figure style={figStyle} role="img" aria-label={caption}>
      <svg viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', display: 'block' }}>
        ...
        {['1. Official portal → Farmers Corner','2. Edit Aadhaar Details option chuniye','3. Aadhaar + old mobile se verify karein','4. New mobile number enter karein','5. OTP verify → Submit','✅ 24-48 hrs mein update hoga'].map((s,i)=>(
        ...
        {['1. CSC centre ya Block office jao','2. Aadhaar card original + copy lao','3. PM Kisan enrolled documents lao','4. Mobile update form bharo','5. Officer verify karega','✅ 7-15 din mein update hoga'].map((s,i)=>(
...
export function SvgKisanLoan({ caption }: { caption: string }) {
  return (
    <figure className="my-6 rounded-2xl overflow-hidden border border-green-100 bg-green-50" role="img" aria-label={caption}>
      <svg viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-32 md:h-44">
        <rect width="800" height="200" fill="#f0fdf4"/>
        {[['Kisan Credit Card',60,'#4ade80','#15803d'],['Bank Loan',230,'#86efac','#166534'],['NABARD',400,'#4ade80','#15803d'],['CSC',570,'#86efac','#166534']].map(([label,x,fill,tc])=>(
