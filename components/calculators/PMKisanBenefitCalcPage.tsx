    ...
    <>
      ...
      <div className="container-site max-w-2xl py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          {/* Results */}
          {!eligible ? (
            <div className="mt-4 p-5 bg-orange-50 border-2 border-orange-300 rounded-2xl text-center">
              <span className="text-3xl block mb-2">⚠️</span>
              {hasEkyc==='no' ? (
                <>
                  <p className="font-black text-orange-800 mb-1">eKYC Pending — Kist Rok Sakti Hai!</p>
                  <p className="text-sm text-orange-700 mb-3">Jab tak eKYC nahi hogi, payment nahi aayegi — chahe sab kuch sahi ho.</p>
                ...
                <>
                  <p className="font-black text-red-800 mb-1">2 Hectare Se Zyada — Ineligible</p>
                  <p className="text-sm text-red-700">PM Kisan ke liye 2 hectare (5 acre) tak ki zameen wale eligible hain.</p>
                </>
              )}
            </div>
          ) : (
            <div className="mt-4 bg-green-50 border-2 border-green-300 rounded-2xl p-5">
              <p className="text-xs text-green-700 font-bold uppercase tracking-wide mb-3">📊 Aapka PM Kisan Benefit</p>
